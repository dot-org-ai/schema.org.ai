---
$id: https://tech.org.ai/Wunderlist
...
await $.Technology.create(wunderlist)
```

## Resources

- [Wunderlist](https://wunderlist.com)
- [Zapier Integration](https://zapier.com/apps/wunderlist/integrations)
