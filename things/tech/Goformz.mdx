...
await $.Technology.create(goformz)
```

## Resources

- [Goformz](https://goformz.com)
- [Zapier Integration](https://zapier.com/apps/goformz/integrations)
