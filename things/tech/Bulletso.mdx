...
await $.Technology.create(bulletso)
```

## Resources

- [Bulletso](https://bulletso.com)
- [Zapier Integration](https://zapier.com/apps/bulletso/integrations)
