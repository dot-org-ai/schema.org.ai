...
await $.Technology.create(smeetz)
```

## Resources

- [Smeetz](https://smeetz.com)
- [Zapier Integration](https://zapier.com/apps/smeetz/integrations)
