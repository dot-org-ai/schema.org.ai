...
await $.Technology.create(riseup)
```

## Resources

- [Rise Up](https://riseup.com)
- [Zapier Integration](https://zapier.com/apps/rise-up/integrations)
