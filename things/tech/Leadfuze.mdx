...
await $.Technology.create(leadfuze)
```

## Resources

- [Leadfuze](https://leadfuze.com)
- [Zapier Integration](https://zapier.com/apps/leadfuze/integrations)
