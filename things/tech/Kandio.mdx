...
await $.Technology.create(kandio)
```

## Resources

- [Kandio](https://kandio.com)
- [Zapier Integration](https://zapier.com/apps/kandio/integrations)
