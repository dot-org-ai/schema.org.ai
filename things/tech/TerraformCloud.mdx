...
await $.Technology.create(terraformcloud)
```

## Resources

- [Terraform Cloud](https://terraformcloud.com)
- [Zapier Integration](https://zapier.com/apps/terraform-cloud/integrations)
