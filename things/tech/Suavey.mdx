...
await $.Technology.create(suavey)
```

## Resources

- [Suavey](https://suavey.com)
- [Zapier Integration](https://zapier.com/apps/suavey/integrations)
