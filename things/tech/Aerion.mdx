...
await $.Technology.create(aerion)
```

## Resources

- [Aerion](https://aerion.com)
- [Zapier Integration](https://zapier.com/apps/aerion/integrations)
