---
$id: https://tech.org.ai/Donateright
$context: https://schema.org.ai
$type: Technology
name: Donateright
description: Business platform for business automation
url: https://donateright.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Donateright
  url: https://donateright.com
zapierSlug: donateright
digital: 1.0
---
...
await $.Technology.create(donateright)
```

## Resources

- [Donateright](https://donateright.com)
- [Zapier Integration](https://zapier.com/apps/donateright/integrations)
