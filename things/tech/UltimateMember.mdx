---
$id: https://tech.org.ai/UltimateMember
...
const ultimatemember = {
  $type: 'Technology',
  name: 'Ultimate Member',
  url: 'https://ultimatemember.com'
}

await $.Technology.create(ultimatemember)
```

## Resources

- [Ultimate Member](https://ultimatemember.com)
- [Zapier Integration](https://zapier.com/apps/ultimate-member/integrations)
