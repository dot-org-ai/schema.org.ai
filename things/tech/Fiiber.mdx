...
await $.Technology.create(fiiber)
```

## Resources

- [Fiiber](https://fiiber.com)
- [Zapier Integration](https://zapier.com/apps/fiiber/integrations)
