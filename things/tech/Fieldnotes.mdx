---
$id: https://tech.org.ai/Fieldnotes
$context: https://schema.org.ai
$type: Technology
name: Fieldnotes
description: Business platform for business automation
url: https://fieldnotes.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Fieldnotes
  url: https://fieldnotes.com
zapierSlug: fieldnotes
digital: 1.0
---
...
await $.Technology.create(fieldnotes)
```

## Resources

- [Fieldnotes](https://fieldnotes.com)
- [Zapier Integration](https://zapier.com/apps/fieldnotes/integrations)
