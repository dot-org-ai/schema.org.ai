---
$id: https://tech.org.ai/Limblecmms
...
await $.Technology.create(limblecmms)
```

## Resources

- [Limblecmms](https://limblecmms.com)
- [Zapier Integration](https://zapier.com/apps/limblecmms/integrations)
