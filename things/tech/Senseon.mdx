...
await $.Technology.create(senseon)
```

## Resources

- [Senseon](https://senseon.com)
- [Zapier Integration](https://zapier.com/apps/senseon/integrations)
