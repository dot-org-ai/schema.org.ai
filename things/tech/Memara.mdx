...
await $.Technology.create(memara)
```

## Resources

- [Memara](https://memara.com)
- [Zapier Integration](https://zapier.com/apps/memara/integrations)
