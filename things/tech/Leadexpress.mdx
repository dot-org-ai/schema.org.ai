---
$id: https://tech.org.ai/Leadexpress
$context: https://schema.org.ai
$type: Technology
name: Leadexpress
description: Business platform for business automation
url: https://leadexpress.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Leadexpress
  url: https://leadexpress.com
zapierSlug: leadexpress
digital: 1.0
---
...
await $.Technology.create(leadexpress)
```

## Resources

- [Leadexpress](https://leadexpress.com)
- [Zapier Integration](https://zapier.com/apps/leadexpress/integrations)
