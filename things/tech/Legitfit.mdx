...
await $.Technology.create(legitfit)
```

## Resources

- [Legitfit](https://legitfit.com)
- [Zapier Integration](https://zapier.com/apps/legitfit/integrations)
