...
await $.Technology.create(nextsign)
```

## Resources

- [Nextsign](https://nextsign.com)
- [Zapier Integration](https://zapier.com/apps/nextsign/integrations)
