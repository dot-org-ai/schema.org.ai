...
await $.Technology.create(whappy)
```

## Resources

- [Whappy](https://whappy.com)
- [Zapier Integration](https://zapier.com/apps/whappy/integrations)
