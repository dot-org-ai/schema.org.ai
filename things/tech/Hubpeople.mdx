---
$id: https://tech.org.ai/Hubpeople
$context: https://schema.org.ai
$type: Technology
name: Hubpeople
description: Business platform for business automation
url: https://hubpeople.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Hubpeople
  url: https://hubpeople.com
zapierSlug: hubpeople
digital: 1.0
---
...
await $.Technology.create(hubpeople)
```

## Resources

- [Hubpeople](https://hubpeople.com)
- [Zapier Integration](https://zapier.com/apps/hubpeople/integrations)
