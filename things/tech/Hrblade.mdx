...
await $.Technology.create(hrblade)
```

## Resources

- [Hrblade](https://hrblade.com)
- [Zapier Integration](https://zapier.com/apps/hrblade/integrations)
