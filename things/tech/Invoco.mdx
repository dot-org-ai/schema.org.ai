...
await $.Technology.create(invoco)
```

## Resources

- [Invoco](https://invoco.com)
- [Zapier Integration](https://zapier.com/apps/invoco/integrations)
