...
await $.Technology.create(ticketio)
```

## Resources

- [Ticketio](https://ticketio.com)
- [Zapier Integration](https://zapier.com/apps/ticketio/integrations)
