---
$id: https://tech.org.ai/Surveynoodle
...
await $.Technology.create(surveynoodle)
```

## Resources

- [Surveynoodle](https://surveynoodle.com)
- [Zapier Integration](https://zapier.com/apps/surveynoodle/integrations)
