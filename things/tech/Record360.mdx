...
await $.Technology.create(record360)
```

## Resources

- [Record360](https://record360.com)
- [Zapier Integration](https://zapier.com/apps/record360/integrations)
