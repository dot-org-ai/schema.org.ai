...
await $.Technology.create(assigned)
```

## Resources

- [Assigned](https://assigned.com)
- [Zapier Integration](https://zapier.com/apps/assigned/integrations)
