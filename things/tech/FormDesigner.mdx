...
await $.Technology.create(formdesigner)
```

## Resources

- [Formdesigner](https://formdesigner.com)
- [Zapier Integration](https://zapier.com/apps/formdesigner/integrations)
