---
$id: https://tech.org.ai/Szybkisms
$context: https://schema.org.ai
$type: Technology
name: Szybkisms
description: Business platform for business automation
url: https://szybkisms.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Szybkisms
  url: https://szybkisms.com
zapierSlug: szybkisms
digital: 1.0
---
...
await $.Technology.create(szybkisms)
```

## Resources

- [Szybkisms](https://szybkisms.com)
- [Zapier Integration](https://zapier.com/apps/szybkisms/integrations)
