...
await $.Technology.create(bizzow)
```

## Resources

- [Bizzow](https://bizzow.com)
- [Zapier Integration](https://zapier.com/apps/bizzow/integrations)
