...
await $.Technology.create(leadmate)
```

## Resources

- [Leadmate](https://leadmate.com)
- [Zapier Integration](https://zapier.com/apps/leadmate/integrations)
