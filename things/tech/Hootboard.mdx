---
$id: https://tech.org.ai/Hootboard
...
await $.Technology.create(hootboard)
```

## Resources

- [Hootboard](https://hootboard.com)
- [Zapier Integration](https://zapier.com/apps/hootboard/integrations)
