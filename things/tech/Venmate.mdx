...
await $.Technology.create(venmate)
```

## Resources

- [Venmate](https://venmate.com)
- [Zapier Integration](https://zapier.com/apps/venmate/integrations)
