---
$id: https://tech.org.ai/Openasset
...
await $.Technology.create(openasset)
```

## Resources

- [Openasset](https://openasset.com)
- [Zapier Integration](https://zapier.com/apps/openasset/integrations)
