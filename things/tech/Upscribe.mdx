...
await $.Technology.create(upscribe)
```

## Resources

- [Upscribe](https://upscribe.com)
- [Zapier Integration](https://zapier.com/apps/upscribe/integrations)
