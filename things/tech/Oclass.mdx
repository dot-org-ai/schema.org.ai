...
await $.Technology.create(oclass)
```

## Resources

- [Oclass](https://oclass.com)
- [Zapier Integration](https://zapier.com/apps/oclass/integrations)
