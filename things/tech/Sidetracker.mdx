---
$id: https://tech.org.ai/Sidetracker
$context: https://schema.org.ai
$type: Technology
name: Sidetracker
description: Business platform for business automation
url: https://sidetracker.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Sidetracker
  url: https://sidetracker.com
zapierSlug: sidetracker
digital: 1.0
---
...
await $.Technology.create(sidetracker)
```

## Resources

- [Sidetracker](https://sidetracker.com)
- [Zapier Integration](https://zapier.com/apps/sidetracker/integrations)
