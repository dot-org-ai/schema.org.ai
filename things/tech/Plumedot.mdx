...
await $.Technology.create(plumedot)
```

## Resources

- [Plumedot](https://plumedot.com)
- [Zapier Integration](https://zapier.com/apps/plumedot/integrations)
