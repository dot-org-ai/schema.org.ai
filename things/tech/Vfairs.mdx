...
- AttendeeRegisters.created
- ExhibitorRegisters.created
- LeadRegistered.created
...
await $.Technology.create(vfairs)
```

## Resources

- [Vfairs](https://vfairs.com)
- [Zapier Integration](https://zapier.com/apps/vfairs/integrations)
