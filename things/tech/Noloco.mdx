...
await $.Technology.create(noloco)
```

## Resources

- [Noloco](https://noloco.com)
- [Zapier Integration](https://zapier.com/apps/noloco/integrations)
