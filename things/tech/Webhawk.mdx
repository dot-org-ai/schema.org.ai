...
await $.Technology.create(webhawk)
```

## Resources

- [Webhawk](https://webhawk.com)
- [Zapier Integration](https://zapier.com/apps/webhawk/integrations)
