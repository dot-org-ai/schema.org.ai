...
await $.Technology.create(sendiio)
```

## Resources

- [Sendiio](https://sendiio.com)
- [Zapier Integration](https://zapier.com/apps/sendiio/integrations)
