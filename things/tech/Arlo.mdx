...
- BasicEvent.created
- Basic.update
- ElearningRegistration.created
- Elearning.update
- Multi-SessionEvent.created
...
await $.Technology.create(arlo)
```

## Resources

- [Arlo](https://arlo.com)
- [Zapier Integration](https://zapier.com/apps/arlo/integrations)
