...
await $.Technology.create(hompwr)
```

## Resources

- [Hompwr](https://hompwr.com)
- [Zapier Integration](https://zapier.com/apps/hompwr/integrations)
