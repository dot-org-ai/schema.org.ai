---
$id: https://tech.org.ai/Asknicely
...
await $.Technology.create(asknicely)
```

## Resources

- [Asknicely](https://asknicely.com)
- [Zapier Integration](https://zapier.com/apps/asknicely/integrations)
