...
await $.Technology.create(leadquiz)
```

## Resources

- [Leadquiz](https://leadquiz.com)
- [Zapier Integration](https://zapier.com/apps/leadquiz/integrations)
