...
await $.Technology.create(chatbotworld)
```

## Resources

- [Chatbotworld](https://chatbotworld.com)
- [Zapier Integration](https://zapier.com/apps/chatbotworld/integrations)
