---
$id: https://tech.org.ai/Ispeedtolead
...
await $.Technology.create(ispeedtolead)
```

## Resources

- [Ispeedtolead](https://ispeedtolead.com)
- [Zapier Integration](https://zapier.com/apps/ispeedtolead/integrations)
