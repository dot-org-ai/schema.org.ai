...
await $.Technology.create(rapidoform)
```

## Resources

- [Rapidoform](https://rapidoform.com)
- [Zapier Integration](https://zapier.com/apps/rapidoform/integrations)
