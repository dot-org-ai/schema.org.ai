---
$id: https://tech.org.ai/Smartdialog
$context: https://schema.org.ai
$type: Technology
name: Smartdialog
description: Business platform for business automation
url: https://smartdialog.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Smartdialog
  url: https://smartdialog.com
zapierSlug: smartdialog
digital: 1.0
---
...
await $.Technology.create(smartdialog)
```

## Resources

- [Smartdialog](https://smartdialog.com)
- [Zapier Integration](https://zapier.com/apps/smartdialog/integrations)
