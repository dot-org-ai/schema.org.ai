...
await $.Technology.create(mallabe)
```

## Resources

- [Mallabe](https://mallabe.com)
- [Zapier Integration](https://zapier.com/apps/mallabe/integrations)
