...
await $.Technology.create(leadfox)
```

## Resources

- [Leadfox](https://leadfox.com)
- [Zapier Integration](https://zapier.com/apps/leadfox/integrations)
