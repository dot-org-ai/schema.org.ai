---
$id: https://tech.org.ai/PinterestLeadAds
$context: https://schema.org.ai
$type: Technology
name: Pinterest Lead Ads
description: Business platform for business automation
url: https://pinterestleadads.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Pinterest Lead Ads
  url: https://pinterestleadads.com
zapierSlug: pinterest-lead-ads
digital: 1.0
---
...
const pinterestleadads = {
  $type: 'Technology',
  name: 'Pinterest Lead Ads',
  url: 'https://pinterestleadads.com'
}

await $.Technology.create(pinterestleadads)
```

## Resources

- [Pinterest Lead Ads](https://pinterestleadads.com)
- [Zapier Integration](https://zapier.com/apps/pinterest-lead-ads/integrations)
