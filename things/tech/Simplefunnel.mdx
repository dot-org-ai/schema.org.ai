---
$id: https://tech.org.ai/Simplefunnel
$context: https://schema.org.ai
$type: Technology
name: Simplefunnel
description: Business platform for business automation
url: https://simplefunnel.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Simplefunnel
  url: https://simplefunnel.com
zapierSlug: simplefunnel
digital: 1.0
---
...
await $.Technology.create(simplefunnel)
```

## Resources

- [Simplefunnel](https://simplefunnel.com)
- [Zapier Integration](https://zapier.com/apps/simplefunnel/integrations)
