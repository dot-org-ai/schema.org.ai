---
$id: https://tech.org.ai/Autoretouch
...
await $.Technology.create(autoretouch)
```

## Resources

- [Autoretouch](https://autoretouch.com)
- [Zapier Integration](https://zapier.com/apps/autoretouch/integrations)
