---
$id: https://tech.org.ai/Slickstream
$context: https://schema.org.ai
$type: Technology
name: Slickstream
description: Business platform for business automation
url: https://slickstream.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Slickstream
  url: https://slickstream.com
zapierSlug: slickstream
digital: 1.0
---
...
await $.Technology.create(slickstream)
```

## Resources

- [Slickstream](https://slickstream.com)
- [Zapier Integration](https://zapier.com/apps/slickstream/integrations)
