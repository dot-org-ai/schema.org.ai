---
$id: https://tech.org.ai/FlowTeams
$context: https://schema.org.ai
$type: Technology
name: Flow Teams
description: Business platform for business automation
url: https://flowteams.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Flow Teams
  url: https://flowteams.com
zapierSlug: flow-teams
digital: 1.0
---
...
await $.Technology.create(flowteams)
```

## Resources

- [Flow Teams](https://flowteams.com)
- [Zapier Integration](https://zapier.com/apps/flow-teams/integrations)
