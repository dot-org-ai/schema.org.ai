...
await $.Technology.create(cronycle)
```

## Resources

- [Cronycle](https://cronycle.com)
- [Zapier Integration](https://zapier.com/apps/cronycle/integrations)
