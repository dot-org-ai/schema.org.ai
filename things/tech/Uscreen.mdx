...
await $.Technology.create(uscreen)
```

## Resources

- [Uscreen](https://uscreen.com)
- [Zapier Integration](https://zapier.com/apps/uscreen/integrations)
