---
$id: https://tech.org.ai/Loyaltydog
$context: https://schema.org.ai
$type: Technology
name: Loyaltydog
description: Business platform for business automation
url: https://loyaltydog.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Loyaltydog
  url: https://loyaltydog.com
zapierSlug: loyaltydog
digital: 1.0
---
...
await $.Technology.create(loyaltydog)
```

## Resources

- [Loyaltydog](https://loyaltydog.com)
- [Zapier Integration](https://zapier.com/apps/loyaltydog/integrations)
