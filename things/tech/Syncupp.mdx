...
await $.Technology.create(syncupp)
```

## Resources

- [Syncupp](https://syncupp.com)
- [Zapier Integration](https://zapier.com/apps/syncupp/integrations)
