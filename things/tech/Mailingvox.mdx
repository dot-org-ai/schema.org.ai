---
$id: https://tech.org.ai/Mailingvox
$context: https://schema.org.ai
$type: Technology
name: Mailingvox
description: Business platform for business automation
url: https://mailingvox.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Mailingvox
  url: https://mailingvox.com
zapierSlug: mailingvox
digital: 1.0
---
...
await $.Technology.create(mailingvox)
```

## Resources

- [Mailingvox](https://mailingvox.com)
- [Zapier Integration](https://zapier.com/apps/mailingvox/integrations)
