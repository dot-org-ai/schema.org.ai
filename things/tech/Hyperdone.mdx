...
await $.Technology.create(hyperdone)
```

## Resources

- [Hyperdone](https://hyperdone.com)
- [Zapier Integration](https://zapier.com/apps/hyperdone/integrations)
