...
await $.Technology.create(novusbot)
```

## Resources

- [Novusbot](https://novusbot.com)
- [Zapier Integration](https://zapier.com/apps/novusbot/integrations)
