...
await $.Technology.create(neetokb)
```

## Resources

- [Neetokb](https://neetokb.com)
- [Zapier Integration](https://zapier.com/apps/neetokb/integrations)
