...
await $.Technology.create(clienty)
```

## Resources

- [Clienty](https://clienty.com)
- [Zapier Integration](https://zapier.com/apps/clienty/integrations)
