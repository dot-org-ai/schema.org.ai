...
await $.Technology.create(easydoc)
```

## Resources

- [Easydoc](https://easydoc.com)
- [Zapier Integration](https://zapier.com/apps/easydoc/integrations)
