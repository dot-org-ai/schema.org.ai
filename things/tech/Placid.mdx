...
await $.Technology.create(placid)
```

## Resources

- [Placid](https://placid.com)
- [Zapier Integration](https://zapier.com/apps/placid/integrations)
