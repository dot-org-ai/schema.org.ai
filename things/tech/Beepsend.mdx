...
await $.Technology.create(beepsend)
```

## Resources

- [Beepsend](https://beepsend.com)
- [Zapier Integration](https://zapier.com/apps/beepsend/integrations)
