...
await $.Technology.create(giddyup)
```

## Resources

- [Giddyup](https://giddyup.com)
- [Zapier Integration](https://zapier.com/apps/giddyup/integrations)
