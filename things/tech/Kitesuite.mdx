---
$id: https://tech.org.ai/Kitesuite
$context: https://schema.org.ai
$type: Technology
name: Kitesuite
description: Business platform for business automation
url: https://kitesuite.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Kitesuite
  url: https://kitesuite.com
zapierSlug: kitesuite
digital: 1.0
---
...
await $.Technology.create(kitesuite)
```

## Resources

- [Kitesuite](https://kitesuite.com)
- [Zapier Integration](https://zapier.com/apps/kitesuite/integrations)
