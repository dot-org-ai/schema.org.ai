...
await $.Technology.create(tempokit)
```

## Resources

- [Tempokit](https://tempokit.com)
- [Zapier Integration](https://zapier.com/apps/tempokit/integrations)
