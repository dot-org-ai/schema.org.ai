---
$id: https://tech.org.ai/Hellosells
$context: https://schema.org.ai
$type: Technology
name: Hellosells
description: Business platform for business automation
url: https://hellosells.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Hellosells
  url: https://hellosells.com
zapierSlug: hellosells
digital: 1.0
---
...
await $.Technology.create(hellosells)
```

## Resources

- [Hellosells](https://hellosells.com)
- [Zapier Integration](https://zapier.com/apps/hellosells/integrations)
