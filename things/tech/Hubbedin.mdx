...
await $.Technology.create(hubbedin)
```

## Resources

- [Hubbedin](https://hubbedin.com)
- [Zapier Integration](https://zapier.com/apps/hubbedin/integrations)
