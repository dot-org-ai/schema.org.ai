...
await $.Technology.create(tasktrain)
```

## Resources

- [Tasktrain](https://tasktrain.com)
- [Zapier Integration](https://zapier.com/apps/tasktrain/integrations)
