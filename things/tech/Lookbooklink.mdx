---
$id: https://tech.org.ai/Lookbooklink
$context: https://schema.org.ai
$type: Technology
name: Lookbooklink
description: Business platform for business automation
url: https://lookbooklink.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Lookbooklink
  url: https://lookbooklink.com
zapierSlug: lookbooklink
digital: 1.0
---
...
await $.Technology.create(lookbooklink)
```

## Resources

- [Lookbooklink](https://lookbooklink.com)
- [Zapier Integration](https://zapier.com/apps/lookbooklink/integrations)
