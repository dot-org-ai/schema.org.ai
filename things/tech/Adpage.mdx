...
await $.Technology.create(adpage)
```

## Resources

- [Adpage](https://adpage.com)
- [Zapier Integration](https://zapier.com/apps/adpage/integrations)
