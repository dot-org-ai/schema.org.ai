---
$id: https://tech.org.ai/Trustmary
$context: https://schema.org.ai
$type: Technology
name: Trustmary
description: Business platform for business automation
url: https://trustmary.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Trustmary
  url: https://trustmary.com
zapierSlug: trustmary
digital: 1.0
---
...
await $.Technology.create(trustmary)
```

## Resources

- [Trustmary](https://trustmary.com)
- [Zapier Integration](https://zapier.com/apps/trustmary/integrations)
