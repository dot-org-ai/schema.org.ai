...
await $.Technology.create(runrunit)
```

## Resources

- [Runrunit](https://runrunit.com)
- [Zapier Integration](https://zapier.com/apps/runrunit/integrations)
