...
await $.Technology.create(indyforms)
```

## Resources

- [Indyforms](https://indyforms.com)
- [Zapier Integration](https://zapier.com/apps/indyforms/integrations)
