...
await $.Technology.create(boosthub)
```

## Resources

- [Boost Hub](https://boosthub.com)
- [Zapier Integration](https://zapier.com/apps/boost-hub/integrations)
