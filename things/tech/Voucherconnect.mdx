---
$id: https://tech.org.ai/Voucherconnect
$context: https://schema.org.ai
$type: Technology
name: Voucherconnect
description: Business platform for business automation
url: https://voucherconnect.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Voucherconnect
  url: https://voucherconnect.com
zapierSlug: voucherconnect
digital: 1.0
---
...
const voucherconnect = {
  $type: 'Technology',
  name: 'Voucherconnect',
  url: 'https://voucherconnect.com'
}

await $.Technology.create(voucherconnect)
```

## Resources

- [Voucherconnect](https://voucherconnect.com)
- [Zapier Integration](https://zapier.com/apps/voucherconnect/integrations)
