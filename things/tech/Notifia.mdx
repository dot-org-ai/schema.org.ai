...
await $.Technology.create(notifia)
```

## Resources

- [Notifia](https://notifia.com)
- [Zapier Integration](https://zapier.com/apps/notifia/integrations)
