...
await $.Technology.create(crowddev)
```

## Resources

- [Crowddev](https://crowddev.com)
- [Zapier Integration](https://zapier.com/apps/crowddev/integrations)
