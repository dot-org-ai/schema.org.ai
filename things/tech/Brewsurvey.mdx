---
$id: https://tech.org.ai/Brewsurvey
...
await $.Technology.create(brewsurvey)
```

## Resources

- [Brewsurvey](https://brewsurvey.com)
- [Zapier Integration](https://zapier.com/apps/brewsurvey/integrations)
