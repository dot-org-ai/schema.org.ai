---
$id: https://tech.org.ai/Brandmentions
...
await $.Technology.create(brandmentions)
```

## Resources

- [Brandmentions](https://brandmentions.com)
- [Zapier Integration](https://zapier.com/apps/brandmentions/integrations)
