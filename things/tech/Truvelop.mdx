...
await $.Technology.create(truvelop)
```

## Resources

- [Truvelop](https://truvelop.com)
- [Zapier Integration](https://zapier.com/apps/truvelop/integrations)
