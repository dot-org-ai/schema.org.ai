...
await $.Technology.create(zotabox)
```

## Resources

- [Zotabox](https://zotabox.com)
- [Zapier Integration](https://zapier.com/apps/zotabox/integrations)
