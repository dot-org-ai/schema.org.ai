...
await $.Technology.create(escala)
```

## Resources

- [Escala](https://escala.com)
- [Zapier Integration](https://zapier.com/apps/escala/integrations)
