...
await $.Technology.create(filevine)
```

## Resources

- [Filevine](https://filevine.com)
- [Zapier Integration](https://zapier.com/apps/filevine/integrations)
