...
await $.Technology.create(hackmd)
```

## Resources

- [Hackmd](https://hackmd.com)
- [Zapier Integration](https://zapier.com/apps/hackmd/integrations)
