---
$id: https://tech.org.ai/Cloudprinter
$context: https://schema.org.ai
$type: Technology
name: Cloudprinter
description: Business platform for business automation
url: https://cloudprinter.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Cloudprinter
  url: https://cloudprinter.com
zapierSlug: cloudprinter
digital: 1.0
---
...
await $.Technology.create(cloudprinter)
```

## Resources

- [Cloudprinter](https://cloudprinter.com)
- [Zapier Integration](https://zapier.com/apps/cloudprinter/integrations)
