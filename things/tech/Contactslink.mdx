---
$id: https://tech.org.ai/Contactslink
$context: https://schema.org.ai
$type: Technology
name: Contactslink
description: Business platform for business automation
url: https://contactslink.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Contactslink
  url: https://contactslink.com
zapierSlug: contactslink
digital: 1.0
---
...
await $.Technology.create(contactslink)
```

## Resources

- [Contactslink](https://contactslink.com)
- [Zapier Integration](https://zapier.com/apps/contactslink/integrations)
