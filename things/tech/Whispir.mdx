...
await $.Technology.create(whispir)
```

## Resources

- [Whispir](https://whispir.com)
- [Zapier Integration](https://zapier.com/apps/whispir/integrations)
