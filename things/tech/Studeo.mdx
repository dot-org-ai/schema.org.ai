...
await $.Technology.create(studeo)
```

## Resources

- [Studeo](https://studeo.com)
- [Zapier Integration](https://zapier.com/apps/studeo/integrations)
