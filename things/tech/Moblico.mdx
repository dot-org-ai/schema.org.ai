...
await $.Technology.create(moblico)
```

## Resources

- [Moblico](https://moblico.com)
- [Zapier Integration](https://zapier.com/apps/moblico/integrations)
