...
await $.Technology.create(mailmojo)
```

## Resources

- [Mailmojo](https://mailmojo.com)
- [Zapier Integration](https://zapier.com/apps/mailmojo/integrations)
