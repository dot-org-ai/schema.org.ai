...
await $.Technology.create(filemail)
```

## Resources

- [Filemail](https://filemail.com)
- [Zapier Integration](https://zapier.com/apps/filemail/integrations)
