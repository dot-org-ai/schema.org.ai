...
await $.Technology.create(whattime)
```

## Resources

- [Whattime](https://whattime.com)
- [Zapier Integration](https://zapier.com/apps/whattime/integrations)
