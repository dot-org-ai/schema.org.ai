...
await $.Technology.create(persio)
```

## Resources

- [Persio](https://persio.com)
- [Zapier Integration](https://zapier.com/apps/persio/integrations)
