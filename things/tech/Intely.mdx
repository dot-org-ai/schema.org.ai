...
await $.Technology.create(intely)
```

## Resources

- [Intely](https://intely.com)
- [Zapier Integration](https://zapier.com/apps/intely/integrations)
