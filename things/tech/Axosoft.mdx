...
await $.Technology.create(axosoft)
```

## Resources

- [Axosoft](https://axosoft.com)
- [Zapier Integration](https://zapier.com/apps/axosoft/integrations)
