...
await $.Technology.create(weeztix)
```

## Resources

- [Weeztix](https://weeztix.com)
- [Zapier Integration](https://zapier.com/apps/weeztix/integrations)
