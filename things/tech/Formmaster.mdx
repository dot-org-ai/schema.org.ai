...
await $.Technology.create(formmaster)
```

## Resources

- [Formmaster](https://formmaster.com)
- [Zapier Integration](https://zapier.com/apps/formmaster/integrations)
