...
await $.Technology.create(olivya)
```

## Resources

- [Olivya](https://olivya.com)
- [Zapier Integration](https://zapier.com/apps/olivya/integrations)
