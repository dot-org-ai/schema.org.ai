...
await $.Technology.create(formhivenet)
```

## Resources

- [Formhivenet](https://formhivenet.com)
- [Zapier Integration](https://zapier.com/apps/formhivenet/integrations)
