...
await $.Technology.create(upvoted)
```

## Resources

- [Upvoted](https://upvoted.com)
- [Zapier Integration](https://zapier.com/apps/upvoted/integrations)
