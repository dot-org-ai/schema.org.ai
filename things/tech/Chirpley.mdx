...
await $.Technology.create(chirpley)
```

## Resources

- [Chirpley](https://chirpley.com)
- [Zapier Integration](https://zapier.com/apps/chirpley/integrations)
