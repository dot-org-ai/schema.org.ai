...
await $.Technology.create(onedeck)
```

## Resources

- [Onedeck](https://onedeck.com)
- [Zapier Integration](https://zapier.com/apps/onedeck/integrations)
