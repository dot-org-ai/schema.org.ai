...
await $.Technology.create(flowla)
```

## Resources

- [Flowla](https://flowla.com)
- [Zapier Integration](https://zapier.com/apps/flowla/integrations)
