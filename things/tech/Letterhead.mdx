---
$id: https://tech.org.ai/Letterhead
$context: https://schema.org.ai
$type: Technology
name: Letterhead
description: Business platform for business automation
url: https://letterhead.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Letterhead
  url: https://letterhead.com
zapierSlug: letterhead
digital: 1.0
---
...
- AudienceMember.unknown
- NewsletterScheduled.created
...
await $.Technology.create(letterhead)
```

## Resources

- [Letterhead](https://letterhead.com)
- [Zapier Integration](https://zapier.com/apps/letterhead/integrations)
