---
$id: https://tech.org.ai/Devskiller
...
await $.Technology.create(devskiller)
```

## Resources

- [Devskiller](https://devskiller.com)
- [Zapier Integration](https://zapier.com/apps/devskiller/integrations)
