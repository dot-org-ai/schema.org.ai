...
await $.Technology.create(interwoo)
```

## Resources

- [Interwoo](https://interwoo.com)
- [Zapier Integration](https://zapier.com/apps/interwoo/integrations)
