...
await $.Technology.create(xpertly)
```

## Resources

- [Xpertly](https://xpertly.com)
- [Zapier Integration](https://zapier.com/apps/xpertly/integrations)
