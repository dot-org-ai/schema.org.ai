...
await $.Technology.create(ivadocs)
```

## Resources

- [Iva Docs](https://ivadocs.com)
- [Zapier Integration](https://zapier.com/apps/iva-docs/integrations)
