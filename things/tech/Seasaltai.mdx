---
$id: https://tech.org.ai/Seasaltai
$context: https://schema.org.ai
$type: Technology
name: Seasaltai
description: Business platform for business automation
url: https://seasaltai.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Seasaltai
  url: https://seasaltai.com
zapierSlug: seasaltai
digital: 1.0
---
...
await $.Technology.create(seasaltai)
```

## Resources

- [Seasaltai](https://seasaltai.com)
- [Zapier Integration](https://zapier.com/apps/seasaltai/integrations)
