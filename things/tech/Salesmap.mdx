...
await $.Technology.create(salesmap)
```

## Resources

- [Salesmap](https://salesmap.com)
- [Zapier Integration](https://zapier.com/apps/salesmap/integrations)
