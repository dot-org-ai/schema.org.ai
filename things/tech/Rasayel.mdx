...
await $.Technology.create(rasayel)
```

## Resources

- [Rasayel](https://rasayel.com)
- [Zapier Integration](https://zapier.com/apps/rasayel/integrations)
