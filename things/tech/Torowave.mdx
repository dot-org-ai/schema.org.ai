...
await $.Technology.create(torowave)
```

## Resources

- [Torowave](https://torowave.com)
- [Zapier Integration](https://zapier.com/apps/torowave/integrations)
