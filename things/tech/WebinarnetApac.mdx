---
$id: https://tech.org.ai/WebinarnetApac
$context: https://schema.org.ai
$type: Technology
name: Webinarnet Apac
description: Business platform for business automation
url: https://webinarnetapac.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Webinarnet Apac
  url: https://webinarnetapac.com
zapierSlug: webinarnet-apac
digital: 1.0
---
...
const webinarnetapac = {
  $type: 'Technology',
  name: 'Webinarnet Apac',
  url: 'https://webinarnetapac.com'
}

await $.Technology.create(webinarnetapac)
```

## Resources

- [Webinarnet Apac](https://webinarnetapac.com)
- [Zapier Integration](https://zapier.com/apps/webinarnet-apac/integrations)
