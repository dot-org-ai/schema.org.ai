...
await $.Technology.create(charla)
```

## Resources

- [Charla](https://charla.com)
- [Zapier Integration](https://zapier.com/apps/charla/integrations)
