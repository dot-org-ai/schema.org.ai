...
await $.Technology.create(quizitri)
```

## Resources

- [Quizitri](https://quizitri.com)
- [Zapier Integration](https://zapier.com/apps/quizitri/integrations)
