...
await $.Technology.create(yumisign)
```

## Resources

- [Yumisign](https://yumisign.com)
- [Zapier Integration](https://zapier.com/apps/yumisign/integrations)
