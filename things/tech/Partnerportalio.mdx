---
$id: https://tech.org.ai/Partnerportalio
$context: https://schema.org.ai
$type: Technology
name: Partnerportalio
description: Business platform for business automation
url: https://partnerportalio.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Partnerportalio
  url: https://partnerportalio.com
zapierSlug: partnerportalio
digital: 1.0
---
...
const partnerportalio = {
  $type: 'Technology',
  name: 'Partnerportalio',
  url: 'https://partnerportalio.com'
}

await $.Technology.create(partnerportalio)
```

## Resources

- [Partnerportalio](https://partnerportalio.com)
- [Zapier Integration](https://zapier.com/apps/partnerportalio/integrations)
