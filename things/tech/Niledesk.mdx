...
await $.Technology.create(niledesk)
```

## Resources

- [Niledesk](https://niledesk.com)
- [Zapier Integration](https://zapier.com/apps/niledesk/integrations)
