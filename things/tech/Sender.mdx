...
await $.Technology.create(sender)
```

## Resources

- [Sender](https://sender.com)
- [Zapier Integration](https://zapier.com/apps/sender/integrations)
