...
await $.Technology.create(starton)
```

## Resources

- [Starton](https://starton.com)
- [Zapier Integration](https://zapier.com/apps/starton/integrations)
