...
await $.Technology.create(rezora)
```

## Resources

- [Rezora](https://rezora.com)
- [Zapier Integration](https://zapier.com/apps/rezora/integrations)
