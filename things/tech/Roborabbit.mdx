...
await $.Technology.create(roborabbit)
```

## Resources

- [Roborabbit](https://roborabbit.com)
- [Zapier Integration](https://zapier.com/apps/roborabbit/integrations)
