...
await $.Technology.create(coosto)
```

## Resources

- [Coosto](https://coosto.com)
- [Zapier Integration](https://zapier.com/apps/coosto/integrations)
