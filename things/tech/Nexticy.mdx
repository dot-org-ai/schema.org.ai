...
await $.Technology.create(nexticy)
```

## Resources

- [Nexticy](https://nexticy.com)
- [Zapier Integration](https://zapier.com/apps/nexticy/integrations)
