...
await $.Technology.create(releai)
```

## Resources

- [Releai](https://releai.com)
- [Zapier Integration](https://zapier.com/apps/releai/integrations)
