...
await $.Technology.create(tyntec)
```

## Resources

- [Tyntec](https://tyntec.com)
- [Zapier Integration](https://zapier.com/apps/tyntec/integrations)
