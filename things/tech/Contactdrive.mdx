---
$id: https://tech.org.ai/Contactdrive
$context: https://schema.org.ai
$type: Technology
name: Contactdrive
description: Business platform for business automation
url: https://contactdrive.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Contactdrive
  url: https://contactdrive.com
zapierSlug: contactdrive
digital: 1.0
---
...
await $.Technology.create(contactdrive)
```

## Resources

- [Contactdrive](https://contactdrive.com)
- [Zapier Integration](https://zapier.com/apps/contactdrive/integrations)
