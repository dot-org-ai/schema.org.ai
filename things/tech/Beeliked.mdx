...
await $.Technology.create(beeliked)
```

## Resources

- [Beeliked](https://beeliked.com)
- [Zapier Integration](https://zapier.com/apps/beeliked/integrations)
