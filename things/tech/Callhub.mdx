...
await $.Technology.create(callhub)
```

## Resources

- [Callhub](https://callhub.com)
- [Zapier Integration](https://zapier.com/apps/callhub/integrations)
