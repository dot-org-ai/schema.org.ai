...
await $.Technology.create(survio)
```

## Resources

- [Survio](https://survio.com)
- [Zapier Integration](https://zapier.com/apps/survio/integrations)
