...
- Purchase.created
- FormSubscriber.created
- SequenceSubscriber.created
...
await $.Technology.create(kit)
```

## Resources

- [Kit](https://kit.com)
- [Zapier Integration](https://zapier.com/apps/kit/integrations)
