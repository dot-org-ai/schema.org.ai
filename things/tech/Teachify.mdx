...
await $.Technology.create(teachify)
```

## Resources

- [Teachify](https://teachify.com)
- [Zapier Integration](https://zapier.com/apps/teachify/integrations)
