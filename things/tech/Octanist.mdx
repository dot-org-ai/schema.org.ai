...
await $.Technology.create(octanist)
```

## Resources

- [Octanist](https://octanist.com)
- [Zapier Integration](https://zapier.com/apps/octanist/integrations)
