...
await $.Technology.create(elevatie)
```

## Resources

- [Elevatie](https://elevatie.com)
- [Zapier Integration](https://zapier.com/apps/elevatie/integrations)
