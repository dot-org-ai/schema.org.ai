---
$id: https://tech.org.ai/Metaforce
$context: https://schema.org.ai
$type: Technology
name: Metaforce
description: Business platform for business automation
url: https://metaforce.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Metaforce
  url: https://metaforce.com
zapierSlug: metaforce
digital: 1.0
---
...
await $.Technology.create(metaforce)
```

## Resources

- [Metaforce](https://metaforce.com)
- [Zapier Integration](https://zapier.com/apps/metaforce/integrations)
