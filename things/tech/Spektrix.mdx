...
await $.Technology.create(spektrix)
```

## Resources

- [Spektrix](https://spektrix.com)
- [Zapier Integration](https://zapier.com/apps/spektrix/integrations)
