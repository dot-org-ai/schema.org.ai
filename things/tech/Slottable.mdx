---
$id: https://tech.org.ai/Slottable
$context: https://schema.org.ai
$type: Technology
name: Slottable
description: Business platform for business automation
url: https://slottable.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Slottable
  url: https://slottable.com
zapierSlug: slottable
digital: 1.0
---
...
await $.Technology.create(slottable)
```

## Resources

- [Slottable](https://slottable.com)
- [Zapier Integration](https://zapier.com/apps/slottable/integrations)
