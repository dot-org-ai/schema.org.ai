...
await $.Technology.create(myhomeiq)
```

## Resources

- [Myhomeiq](https://myhomeiq.com)
- [Zapier Integration](https://zapier.com/apps/myhomeiq/integrations)
