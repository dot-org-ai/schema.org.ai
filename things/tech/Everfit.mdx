...
await $.Technology.create(everfit)
```

## Resources

- [Everfit](https://everfit.com)
- [Zapier Integration](https://zapier.com/apps/everfit/integrations)
