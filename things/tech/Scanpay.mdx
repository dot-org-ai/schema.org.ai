...
await $.Technology.create(scanpay)
```

## Resources

- [Scanpay](https://scanpay.com)
- [Zapier Integration](https://zapier.com/apps/scanpay/integrations)
