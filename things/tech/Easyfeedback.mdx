---
$id: https://tech.org.ai/Easyfeedback
$context: https://schema.org.ai
$type: Technology
name: Easyfeedback
description: Business platform for business automation
url: https://easyfeedback.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Easyfeedback
  url: https://easyfeedback.com
zapierSlug: easyfeedback
digital: 1.0
---
...
await $.Technology.create(easyfeedback)
```

## Resources

- [Easyfeedback](https://easyfeedback.com)
- [Zapier Integration](https://zapier.com/apps/easyfeedback/integrations)
