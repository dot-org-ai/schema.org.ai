---
$id: https://tech.org.ai/Manycontacts
$context: https://schema.org.ai
$type: Technology
name: Manycontacts
description: Business platform for business automation
url: https://manycontacts.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Manycontacts
  url: https://manycontacts.com
zapierSlug: manycontacts
digital: 1.0
---
...
await $.Technology.create(manycontacts)
```

## Resources

- [Manycontacts](https://manycontacts.com)
- [Zapier Integration](https://zapier.com/apps/manycontacts/integrations)
