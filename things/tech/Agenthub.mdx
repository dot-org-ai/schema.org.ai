...
await $.Technology.create(agenthub)
```

## Resources

- [Agenthub](https://agenthub.com)
- [Zapier Integration](https://zapier.com/apps/agenthub/integrations)
