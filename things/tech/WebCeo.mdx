...
await $.Technology.create(webceo)
```

## Resources

- [Web Ceo](https://webceo.com)
- [Zapier Integration](https://zapier.com/apps/web-ceo/integrations)
