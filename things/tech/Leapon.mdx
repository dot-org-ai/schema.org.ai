...
await $.Technology.create(leapon)
```

## Resources

- [Leapon](https://leapon.com)
- [Zapier Integration](https://zapier.com/apps/leapon/integrations)
