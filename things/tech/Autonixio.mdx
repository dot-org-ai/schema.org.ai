---
$id: https://tech.org.ai/Autonixio
$context: https://schema.org.ai
$type: Technology
name: Autonixio
description: Business platform for business automation
url: https://autonixio.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Autonixio
  url: https://autonixio.com
zapierSlug: autonixio
digital: 1.0
---
...
await $.Technology.create(autonixio)
```

## Resources

- [Autonixio](https://autonixio.com)
- [Zapier Integration](https://zapier.com/apps/autonixio/integrations)
