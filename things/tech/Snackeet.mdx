...
await $.Technology.create(snackeet)
```

## Resources

- [Snackeet](https://snackeet.com)
- [Zapier Integration](https://zapier.com/apps/snackeet/integrations)
