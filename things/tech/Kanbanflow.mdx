---
$id: https://tech.org.ai/Kanbanflow
...
await $.Technology.create(kanbanflow)
```

## Resources

- [Kanbanflow](https://kanbanflow.com)
- [Zapier Integration](https://zapier.com/apps/kanbanflow/integrations)
