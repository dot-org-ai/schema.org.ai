---
$id: https://tech.org.ai/Mybizzmail
$context: https://schema.org.ai
$type: Technology
name: Mybizzmail
description: Business platform for business automation
url: https://mybizzmail.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Mybizzmail
  url: https://mybizzmail.com
zapierSlug: mybizzmail
digital: 1.0
---
...
await $.Technology.create(mybizzmail)
```

## Resources

- [Mybizzmail](https://mybizzmail.com)
- [Zapier Integration](https://zapier.com/apps/mybizzmail/integrations)
