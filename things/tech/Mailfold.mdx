...
await $.Technology.create(mailfold)
```

## Resources

- [Mailfold](https://mailfold.com)
- [Zapier Integration](https://zapier.com/apps/mailfold/integrations)
