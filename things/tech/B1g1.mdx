...
- CampaignGiving.created
- EngagementImpact.created
...
await $.Technology.create(b1g1)
```

## Resources

- [B1g1](https://b1g1.com)
- [Zapier Integration](https://zapier.com/apps/b1g1/integrations)
