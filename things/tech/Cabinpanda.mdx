---
$id: https://tech.org.ai/Cabinpanda
$context: https://schema.org.ai
$type: Technology
name: Cabinpanda
description: Business platform for business automation
url: https://cabinpanda.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Cabinpanda
  url: https://cabinpanda.com
zapierSlug: cabinpanda
digital: 1.0
---
...
await $.Technology.create(cabinpanda)
```

## Resources

- [Cabinpanda](https://cabinpanda.com)
- [Zapier Integration](https://zapier.com/apps/cabinpanda/integrations)
