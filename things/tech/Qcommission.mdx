---
$id: https://tech.org.ai/Qcommission
$context: https://schema.org.ai
$type: Technology
name: Qcommission
description: Business platform for business automation
url: https://qcommission.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Qcommission
  url: https://qcommission.com
zapierSlug: qcommission
digital: 1.0
---
...
await $.Technology.create(qcommission)
```

## Resources

- [Qcommission](https://qcommission.com)
- [Zapier Integration](https://zapier.com/apps/qcommission/integrations)
