...
await $.Technology.create(brunch)
```

## Resources

- [Brunch](https://brunch.com)
- [Zapier Integration](https://zapier.com/apps/brunch/integrations)
