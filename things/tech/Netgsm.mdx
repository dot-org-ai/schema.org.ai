...
await $.Technology.create(netgsm)
```

## Resources

- [Netgsm](https://netgsm.com)
- [Zapier Integration](https://zapier.com/apps/netgsm/integrations)
