---
$id: https://tech.org.ai/Eventscase
...
await $.Technology.create(eventscase)
```

## Resources

- [Eventscase](https://eventscase.com)
- [Zapier Integration](https://zapier.com/apps/eventscase/integrations)
