...
await $.Technology.create(fastgem)
```

## Resources

- [Fastgem](https://fastgem.com)
- [Zapier Integration](https://zapier.com/apps/fastgem/integrations)
