...
await $.Technology.create(leadabode)
```

## Resources

- [Leadabode](https://leadabode.com)
- [Zapier Integration](https://zapier.com/apps/leadabode/integrations)
