...
await $.Technology.create(leadiful)
```

## Resources

- [Leadiful](https://leadiful.com)
- [Zapier Integration](https://zapier.com/apps/leadiful/integrations)
