...
await $.Technology.create(auditcase)
```

## Resources

- [Auditcase](https://auditcase.com)
- [Zapier Integration](https://zapier.com/apps/auditcase/integrations)
