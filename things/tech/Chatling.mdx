...
await $.Technology.create(chatling)
```

## Resources

- [Chatling](https://chatling.com)
- [Zapier Integration](https://zapier.com/apps/chatling/integrations)
