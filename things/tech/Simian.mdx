...
await $.Technology.create(simian)
```

## Resources

- [Simian](https://simian.com)
- [Zapier Integration](https://zapier.com/apps/simian/integrations)
