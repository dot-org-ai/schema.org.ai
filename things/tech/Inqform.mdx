...
await $.Technology.create(inqform)
```

## Resources

- [Inqform](https://inqform.com)
- [Zapier Integration](https://zapier.com/apps/inqform/integrations)
