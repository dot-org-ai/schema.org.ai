---
$id: https://tech.org.ai/Leadboxer
$context: https://schema.org.ai
$type: Technology
name: Leadboxer
description: Business platform for business automation
url: https://leadboxer.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Leadboxer
  url: https://leadboxer.com
zapierSlug: leadboxer
digital: 1.0
---
...
await $.Technology.create(leadboxer)
```

## Resources

- [Leadboxer](https://leadboxer.com)
- [Zapier Integration](https://zapier.com/apps/leadboxer/integrations)
