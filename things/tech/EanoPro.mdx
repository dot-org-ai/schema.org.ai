...
await $.Technology.create(eanopro)
```

## Resources

- [Eano Pro](https://eanopro.com)
- [Zapier Integration](https://zapier.com/apps/eano-pro/integrations)
