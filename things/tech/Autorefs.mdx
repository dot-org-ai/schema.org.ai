...
await $.Technology.create(autorefs)
```

## Resources

- [Autorefs](https://autorefs.com)
- [Zapier Integration](https://zapier.com/apps/autorefs/integrations)
