...
await $.Technology.create(swoogo)
```

## Resources

- [Swoogo](https://swoogo.com)
- [Zapier Integration](https://zapier.com/apps/swoogo/integrations)
