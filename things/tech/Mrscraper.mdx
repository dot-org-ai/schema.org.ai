---
$id: https://tech.org.ai/Mrscraper
...
await $.Technology.create(mrscraper)
```

## Resources

- [Mrscraper](https://mrscraper.com)
- [Zapier Integration](https://zapier.com/apps/mrscraper/integrations)
