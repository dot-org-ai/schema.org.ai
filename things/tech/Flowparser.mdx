---
$id: https://tech.org.ai/Flowparser
$context: https://schema.org.ai
$type: Technology
name: Flowparser
description: Business platform for business automation
url: https://flowparser.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Flowparser
  url: https://flowparser.com
zapierSlug: flowparser
digital: 1.0
---
...
await $.Technology.create(flowparser)
```

## Resources

- [Flowparser](https://flowparser.com)
- [Zapier Integration](https://zapier.com/apps/flowparser/integrations)
