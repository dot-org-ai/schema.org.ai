...
await $.Technology.create(vinesign)
```

## Resources

- [Vinesign](https://vinesign.com)
- [Zapier Integration](https://zapier.com/apps/vinesign/integrations)
