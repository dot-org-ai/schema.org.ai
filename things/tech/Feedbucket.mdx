---
$id: https://tech.org.ai/Feedbucket
...
await $.Technology.create(feedbucket)
```

## Resources

- [Feedbucket](https://feedbucket.com)
- [Zapier Integration](https://zapier.com/apps/feedbucket/integrations)
