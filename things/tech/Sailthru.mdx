...
await $.Technology.create(sailthru)
```

## Resources

- [Sailthru](https://sailthru.com)
- [Zapier Integration](https://zapier.com/apps/sailthru/integrations)
