...
await $.Technology.create(cubeusa)
```

## Resources

- [Cube Usa](https://cubeusa.com)
- [Zapier Integration](https://zapier.com/apps/cube-usa/integrations)
