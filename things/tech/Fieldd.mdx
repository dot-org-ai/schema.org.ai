...
await $.Technology.create(fieldd)
```

## Resources

- [Fieldd](https://fieldd.com)
- [Zapier Integration](https://zapier.com/apps/fieldd/integrations)
