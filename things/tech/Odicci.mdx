...
await $.Technology.create(odicci)
```

## Resources

- [Odicci](https://odicci.com)
- [Zapier Integration](https://zapier.com/apps/odicci/integrations)
