...
await $.Technology.create(laposta)
```

## Resources

- [Laposta](https://laposta.com)
- [Zapier Integration](https://zapier.com/apps/laposta/integrations)
