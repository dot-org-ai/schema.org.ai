...
await $.Technology.create(avanser)
```

## Resources

- [Avanser](https://avanser.com)
- [Zapier Integration](https://zapier.com/apps/avanser/integrations)
