---
$id: https://tech.org.ai/Deutschlandgpt
$context: https://schema.org.ai
$type: Technology
name: Deutschlandgpt
description: Business platform for business automation
url: https://deutschlandgpt.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Deutschlandgpt
  url: https://deutschlandgpt.com
zapierSlug: deutschlandgpt
digital: 1.0
---
...
const deutschlandgpt = {
  $type: 'Technology',
  name: 'Deutschlandgpt',
  url: 'https://deutschlandgpt.com'
}

await $.Technology.create(deutschlandgpt)
```

## Resources

- [Deutschlandgpt](https://deutschlandgpt.com)
- [Zapier Integration](https://zapier.com/apps/deutschlandgpt/integrations)
