...
await $.Technology.create(heyform)
```

## Resources

- [Heyform](https://heyform.com)
- [Zapier Integration](https://zapier.com/apps/heyform/integrations)
