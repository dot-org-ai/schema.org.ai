...
await $.Technology.create(boostnote)
```

## Resources

- [Boost Note](https://boostnote.com)
- [Zapier Integration](https://zapier.com/apps/boost-note/integrations)
