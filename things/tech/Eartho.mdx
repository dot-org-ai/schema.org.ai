...
await $.Technology.create(eartho)
```

## Resources

- [Eartho](https://eartho.com)
- [Zapier Integration](https://zapier.com/apps/eartho/integrations)
