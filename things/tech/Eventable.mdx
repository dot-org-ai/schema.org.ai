---
$id: https://tech.org.ai/Eventable
$context: https://schema.org.ai
$type: Technology
name: Eventable
description: Business platform for business automation
url: https://eventable.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Eventable
  url: https://eventable.com
zapierSlug: eventable
digital: 1.0
---
...
await $.Technology.create(eventable)
```

## Resources

- [Eventable](https://eventable.com)
- [Zapier Integration](https://zapier.com/apps/eventable/integrations)
