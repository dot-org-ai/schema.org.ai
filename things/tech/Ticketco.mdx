...
await $.Technology.create(ticketco)
```

## Resources

- [Ticketco](https://ticketco.com)
- [Zapier Integration](https://zapier.com/apps/ticketco/integrations)
