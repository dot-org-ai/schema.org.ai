...
await $.Technology.create(leadbi)
```

## Resources

- [Leadbi](https://leadbi.com)
- [Zapier Integration](https://zapier.com/apps/leadbi/integrations)
