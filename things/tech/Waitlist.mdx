...
await $.Technology.create(waitlist)
```

## Resources

- [Waitlist](https://waitlist.com)
- [Zapier Integration](https://zapier.com/apps/waitlist/integrations)
