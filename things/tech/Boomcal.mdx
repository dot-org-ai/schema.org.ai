...
await $.Technology.create(boomcal)
```

## Resources

- [Boomcal](https://boomcal.com)
- [Zapier Integration](https://zapier.com/apps/boomcal/integrations)
