...
await $.Technology.create(whatsgw)
```

## Resources

- [Whatsgw](https://whatsgw.com)
- [Zapier Integration](https://zapier.com/apps/whatsgw/integrations)
