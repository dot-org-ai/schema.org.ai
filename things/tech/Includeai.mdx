---
$id: https://tech.org.ai/Includeai
$context: https://schema.org.ai
$type: Technology
name: Includeai
description: Business platform for business automation
url: https://includeai.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Includeai
  url: https://includeai.com
zapierSlug: includeai
digital: 1.0
---
...
await $.Technology.create(includeai)
```

## Resources

- [Includeai](https://includeai.com)
- [Zapier Integration](https://zapier.com/apps/includeai/integrations)
