---
$id: https://tech.org.ai/Passentry
...
await $.Technology.create(passentry)
```

## Resources

- [Passentry](https://passentry.com)
- [Zapier Integration](https://zapier.com/apps/passentry/integrations)
