...
await $.Technology.create(remindee)
```

## Resources

- [Remindee](https://remindee.com)
- [Zapier Integration](https://zapier.com/apps/remindee/integrations)
