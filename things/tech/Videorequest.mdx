...
await $.Technology.create(videorequest)
```

## Resources

- [Videorequest](https://videorequest.com)
- [Zapier Integration](https://zapier.com/apps/videorequest/integrations)
