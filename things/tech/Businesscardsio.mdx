---
$id: https://tech.org.ai/Businesscardsio
$context: https://schema.org.ai
$type: Technology
name: Businesscardsio
description: Business platform for business automation
url: https://businesscardsio.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Businesscardsio
  url: https://businesscardsio.com
zapierSlug: businesscardsio
digital: 1.0
---
...
const businesscardsio = {
  $type: 'Technology',
  name: 'Businesscardsio',
  url: 'https://businesscardsio.com'
}

await $.Technology.create(businesscardsio)
```

## Resources

- [Businesscardsio](https://businesscardsio.com)
- [Zapier Integration](https://zapier.com/apps/businesscardsio/integrations)
