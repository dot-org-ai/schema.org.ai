...
await $.Technology.create(sezion)
```

## Resources

- [Sezion](https://sezion.com)
- [Zapier Integration](https://zapier.com/apps/sezion/integrations)
