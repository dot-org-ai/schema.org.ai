...
await $.Technology.create(hexfit)
```

## Resources

- [Hexfit](https://hexfit.com)
- [Zapier Integration](https://zapier.com/apps/hexfit/integrations)
