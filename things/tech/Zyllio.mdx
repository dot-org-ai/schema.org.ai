...
await $.Technology.create(zyllio)
```

## Resources

- [Zyllio](https://zyllio.com)
- [Zapier Integration](https://zapier.com/apps/zyllio/integrations)
