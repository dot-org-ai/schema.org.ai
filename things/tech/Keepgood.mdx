...
await $.Technology.create(keepgood)
```

## Resources

- [Keepgood](https://keepgood.com)
- [Zapier Integration](https://zapier.com/apps/keepgood/integrations)
