...
await $.Technology.create(formitable)
```

## Resources

- [Formitable](https://formitable.com)
- [Zapier Integration](https://zapier.com/apps/formitable/integrations)
