...
await $.Technology.create(biztera)
```

## Resources

- [Biztera](https://biztera.com)
- [Zapier Integration](https://zapier.com/apps/biztera/integrations)
