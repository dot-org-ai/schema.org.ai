---
$id: https://tech.org.ai/Surveybot
$context: https://schema.org.ai
$type: Technology
name: Surveybot
description: Business platform for business automation
url: https://surveybot.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Surveybot
  url: https://surveybot.com
zapierSlug: surveybot
digital: 1.0
---
...
await $.Technology.create(surveybot)
```

## Resources

- [Surveybot](https://surveybot.com)
- [Zapier Integration](https://zapier.com/apps/surveybot/integrations)
