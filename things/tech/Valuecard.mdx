---
$id: https://tech.org.ai/Valuecard
$context: https://schema.org.ai
$type: Technology
name: Valuecard
description: Business platform for business automation
url: https://valuecard.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Valuecard
  url: https://valuecard.com
zapierSlug: valuecard
digital: 1.0
---
...
await $.Technology.create(valuecard)
```

## Resources

- [Valuecard](https://valuecard.com)
- [Zapier Integration](https://zapier.com/apps/valuecard/integrations)
