---
$id: https://tech.org.ai/Findthatlead
...
await $.Technology.create(findthatlead)
```

## Resources

- [Findthatlead](https://findthatlead.com)
- [Zapier Integration](https://zapier.com/apps/findthatlead/integrations)
