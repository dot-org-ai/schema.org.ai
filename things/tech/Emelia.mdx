...
await $.Technology.create(emelia)
```

## Resources

- [Emelia](https://emelia.com)
- [Zapier Integration](https://zapier.com/apps/emelia/integrations)
