...
await $.Technology.create(onehash)
```

## Resources

- [Onehash](https://onehash.com)
- [Zapier Integration](https://zapier.com/apps/onehash/integrations)
