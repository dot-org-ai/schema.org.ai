...
await $.Technology.create(selftact)
```

## Resources

- [Selftact](https://selftact.com)
- [Zapier Integration](https://zapier.com/apps/selftact/integrations)
