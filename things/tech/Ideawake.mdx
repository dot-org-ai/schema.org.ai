...
await $.Technology.create(ideawake)
```

## Resources

- [Ideawake](https://ideawake.com)
- [Zapier Integration](https://zapier.com/apps/ideawake/integrations)
