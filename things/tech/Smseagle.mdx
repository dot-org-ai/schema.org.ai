...
await $.Technology.create(smseagle)
```

## Resources

- [Smseagle](https://smseagle.com)
- [Zapier Integration](https://zapier.com/apps/smseagle/integrations)
