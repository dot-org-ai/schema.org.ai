...
await $.Technology.create(zanflow)
```

## Resources

- [Zanflow](https://zanflow.com)
- [Zapier Integration](https://zapier.com/apps/zanflow/integrations)
