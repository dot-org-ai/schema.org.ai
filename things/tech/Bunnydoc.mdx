...
await $.Technology.create(bunnydoc)
```

## Resources

- [Bunnydoc](https://bunnydoc.com)
- [Zapier Integration](https://zapier.com/apps/bunnydoc/integrations)
