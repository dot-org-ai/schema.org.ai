...
await $.Technology.create(wisboo)
```

## Resources

- [Wisboo](https://wisboo.com)
- [Zapier Integration](https://zapier.com/apps/wisboo/integrations)
