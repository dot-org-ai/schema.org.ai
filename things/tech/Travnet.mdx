...
await $.Technology.create(travnet)
```

## Resources

- [Travnet](https://travnet.com)
- [Zapier Integration](https://zapier.com/apps/travnet/integrations)
