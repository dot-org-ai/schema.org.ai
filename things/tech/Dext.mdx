...
- Export.unknown
- ProcessedReceipt.created
- ExportReceipts.unknown
...
await $.Technology.create(dext)
```

## Resources

- [Dext](https://dext.com)
- [Zapier Integration](https://zapier.com/apps/dext/integrations)
