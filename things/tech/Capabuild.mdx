---
$id: https://tech.org.ai/Capabuild
$context: https://schema.org.ai
$type: Technology
name: Capabuild
description: Business platform for business automation
url: https://capabuild.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Capabuild
  url: https://capabuild.com
zapierSlug: capabuild
digital: 1.0
---
...
await $.Technology.create(capabuild)
```

## Resources

- [Capabuild](https://capabuild.com)
- [Zapier Integration](https://zapier.com/apps/capabuild/integrations)
