---
$id: https://tech.org.ai/Rightsignature
...
await $.Technology.create(rightsignature)
```

## Resources

- [Rightsignature](https://rightsignature.com)
- [Zapier Integration](https://zapier.com/apps/rightsignature/integrations)
