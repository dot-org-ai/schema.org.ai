...
await $.Technology.create(stampede)
```

## Resources

- [Stampede](https://stampede.com)
- [Zapier Integration](https://zapier.com/apps/stampede/integrations)
