...
await $.Technology.create(endorsal)
```

## Resources

- [Endorsal](https://endorsal.com)
- [Zapier Integration](https://zapier.com/apps/endorsal/integrations)
