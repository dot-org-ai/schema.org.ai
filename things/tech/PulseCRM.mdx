...
await $.Technology.create(pulsecrm)
```

## Resources

- [Pulse CRM](https://pulsecrm.com)
- [Zapier Integration](https://zapier.com/apps/pulse-crm/integrations)
