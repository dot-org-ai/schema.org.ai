---
$id: https://tech.org.ai/Superthread
$context: https://schema.org.ai
$type: Technology
name: Superthread
description: Business platform for business automation
url: https://superthread.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Superthread
  url: https://superthread.com
zapierSlug: superthread
digital: 1.0
---
...
await $.Technology.create(superthread)
```

## Resources

- [Superthread](https://superthread.com)
- [Zapier Integration](https://zapier.com/apps/superthread/integrations)
