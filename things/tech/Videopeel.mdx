...
await $.Technology.create(videopeel)
```

## Resources

- [Videopeel](https://videopeel.com)
- [Zapier Integration](https://zapier.com/apps/videopeel/integrations)
