...
await $.Technology.create(cosiall)
```

## Resources

- [Cosiall](https://cosiall.com)
- [Zapier Integration](https://zapier.com/apps/cosiall/integrations)
