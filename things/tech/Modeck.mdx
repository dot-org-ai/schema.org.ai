...
await $.Technology.create(modeck)
```

## Resources

- [Modeck](https://modeck.com)
- [Zapier Integration](https://zapier.com/apps/modeck/integrations)
