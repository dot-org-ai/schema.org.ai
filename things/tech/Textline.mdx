...
await $.Technology.create(textline)
```

## Resources

- [Textline](https://textline.com)
- [Zapier Integration](https://zapier.com/apps/textline/integrations)
