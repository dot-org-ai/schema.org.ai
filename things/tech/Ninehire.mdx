...
await $.Technology.create(ninehire)
```

## Resources

- [Ninehire](https://ninehire.com)
- [Zapier Integration](https://zapier.com/apps/ninehire/integrations)
