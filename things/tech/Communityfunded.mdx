---
$id: https://tech.org.ai/Communityfunded
$context: https://schema.org.ai
$type: Technology
name: Communityfunded
description: Business platform for business automation
url: https://communityfunded.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Communityfunded
  url: https://communityfunded.com
zapierSlug: communityfunded
digital: 1.0
---
...
const communityfunded = {
  $type: 'Technology',
  name: 'Communityfunded',
  url: 'https://communityfunded.com'
}

await $.Technology.create(communityfunded)
```

## Resources

- [Communityfunded](https://communityfunded.com)
- [Zapier Integration](https://zapier.com/apps/communityfunded/integrations)
