...
await $.Technology.create(ziftone)
```

## Resources

- [Ziftone](https://ziftone.com)
- [Zapier Integration](https://zapier.com/apps/ziftone/integrations)
