---
$id: https://tech.org.ai/Storystream
$context: https://schema.org.ai
$type: Technology
name: Storystream
description: Business platform for business automation
url: https://storystream.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Storystream
  url: https://storystream.com
zapierSlug: storystream
digital: 1.0
---
...
await $.Technology.create(storystream)
```

## Resources

- [Storystream](https://storystream.com)
- [Zapier Integration](https://zapier.com/apps/storystream/integrations)
