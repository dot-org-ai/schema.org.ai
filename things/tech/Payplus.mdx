...
await $.Technology.create(payplus)
```

## Resources

- [Payplus](https://payplus.com)
- [Zapier Integration](https://zapier.com/apps/payplus/integrations)
