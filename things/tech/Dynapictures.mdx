---
$id: https://tech.org.ai/Dynapictures
...
await $.Technology.create(dynapictures)
```

## Resources

- [Dynapictures](https://dynapictures.com)
- [Zapier Integration](https://zapier.com/apps/dynapictures/integrations)
