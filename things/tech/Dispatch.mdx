...
await $.Technology.create(dispatch)
```

## Resources

- [Dispatch](https://dispatch.com)
- [Zapier Integration](https://zapier.com/apps/dispatch/integrations)
