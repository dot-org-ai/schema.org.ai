---
$id: https://tech.org.ai/Adtraction
...
await $.Technology.create(adtraction)
```

## Resources

- [Adtraction](https://adtraction.com)
- [Zapier Integration](https://zapier.com/apps/adtraction/integrations)
