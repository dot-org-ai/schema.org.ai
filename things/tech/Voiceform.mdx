...
await $.Technology.create(voiceform)
```

## Resources

- [Voiceform](https://voiceform.com)
- [Zapier Integration](https://zapier.com/apps/voiceform/integrations)
