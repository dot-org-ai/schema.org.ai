...
await $.Technology.create(vepaar)
```

## Resources

- [Vepaar](https://vepaar.com)
- [Zapier Integration](https://zapier.com/apps/vepaar/integrations)
