...
await $.Technology.create(quilgo)
```

## Resources

- [Quilgo](https://quilgo.com)
- [Zapier Integration](https://zapier.com/apps/quilgo/integrations)
