...
await $.Technology.create(hrmlabs)
```

## Resources

- [Hrmlabs](https://hrmlabs.com)
- [Zapier Integration](https://zapier.com/apps/hrmlabs/integrations)
