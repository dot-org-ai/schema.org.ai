...
await $.Technology.create(chatbo)
```

## Resources

- [Chatbo](https://chatbo.com)
- [Zapier Integration](https://zapier.com/apps/chatbo/integrations)
