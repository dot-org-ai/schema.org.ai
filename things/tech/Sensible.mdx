...
await $.Technology.create(sensible)
```

## Resources

- [Sensible](https://sensible.com)
- [Zapier Integration](https://zapier.com/apps/sensible/integrations)
