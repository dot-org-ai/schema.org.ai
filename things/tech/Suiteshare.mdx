---
$id: https://tech.org.ai/Suiteshare
$context: https://schema.org.ai
$type: Technology
name: Suiteshare
description: Business platform for business automation
url: https://suiteshare.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Suiteshare
  url: https://suiteshare.com
zapierSlug: suiteshare
digital: 1.0
---
...
await $.Technology.create(suiteshare)
```

## Resources

- [Suiteshare](https://suiteshare.com)
- [Zapier Integration](https://zapier.com/apps/suiteshare/integrations)
