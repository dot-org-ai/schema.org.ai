---
$id: https://tech.org.ai/Converflow
$context: https://schema.org.ai
$type: Technology
name: Converflow
description: Business platform for business automation
url: https://converflow.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Converflow
  url: https://converflow.com
zapierSlug: converflow
digital: 1.0
---
...
await $.Technology.create(converflow)
```

## Resources

- [Converflow](https://converflow.com)
- [Zapier Integration](https://zapier.com/apps/converflow/integrations)
