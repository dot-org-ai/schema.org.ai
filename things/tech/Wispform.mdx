...
await $.Technology.create(wispform)
```

## Resources

- [Wispform](https://wispform.com)
- [Zapier Integration](https://zapier.com/apps/wispform/integrations)
