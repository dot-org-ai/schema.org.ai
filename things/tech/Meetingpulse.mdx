...
await $.Technology.create(meetingpulse)
```

## Resources

- [Meetingpulse](https://meetingpulse.com)
- [Zapier Integration](https://zapier.com/apps/meetingpulse/integrations)
