---
$id: https://tech.org.ai/Insurgrid
...
await $.Technology.create(insurgrid)
```

## Resources

- [Insurgrid](https://insurgrid.com)
- [Zapier Integration](https://zapier.com/apps/insurgrid/integrations)
