...
await $.Technology.create(sinorbis)
```

## Resources

- [Sinorbis](https://sinorbis.com)
- [Zapier Integration](https://zapier.com/apps/sinorbis/integrations)
