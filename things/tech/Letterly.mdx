...
await $.Technology.create(letterly)
```

## Resources

- [Letterly](https://letterly.com)
- [Zapier Integration](https://zapier.com/apps/letterly/integrations)
