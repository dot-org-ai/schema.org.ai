...
await $.Technology.create(forecasa)
```

## Resources

- [Forecasa](https://forecasa.com)
- [Zapier Integration](https://zapier.com/apps/forecasa/integrations)
