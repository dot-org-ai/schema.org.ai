...
await $.Technology.create(kintone)
```

## Resources

- [Kintone](https://kintone.com)
- [Zapier Integration](https://zapier.com/apps/kintone/integrations)
