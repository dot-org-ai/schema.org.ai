...
await $.Technology.create(noteforms)
```

## Resources

- [Noteforms](https://noteforms.com)
- [Zapier Integration](https://zapier.com/apps/noteforms/integrations)
