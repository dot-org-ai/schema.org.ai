---
$id: https://tech.org.ai/Peerboard
$context: https://schema.org.ai
$type: Technology
name: Peerboard
description: Business platform for business automation
url: https://peerboard.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Peerboard
  url: https://peerboard.com
zapierSlug: peerboard
digital: 1.0
---
...
- Post.created
- MemberDeactivated.unknown
- MemberActivated.unknown
...
await $.Technology.create(peerboard)
```

## Resources

- [Peerboard](https://peerboard.com)
- [Zapier Integration](https://zapier.com/apps/peerboard/integrations)
