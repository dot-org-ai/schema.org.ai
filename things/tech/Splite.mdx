...
await $.Technology.create(splite)
```

## Resources

- [Splite](https://splite.com)
- [Zapier Integration](https://zapier.com/apps/splite/integrations)
