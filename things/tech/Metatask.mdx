...
await $.Technology.create(metatask)
```

## Resources

- [Metatask](https://metatask.com)
- [Zapier Integration](https://zapier.com/apps/metatask/integrations)
