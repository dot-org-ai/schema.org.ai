---
$id: https://tech.org.ai/Intelfinder
$context: https://schema.org.ai
$type: Technology
name: Intelfinder
description: Business platform for business automation
url: https://intelfinder.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Intelfinder
  url: https://intelfinder.com
zapierSlug: intelfinder
digital: 1.0
---
...
await $.Technology.create(intelfinder)
```

## Resources

- [Intelfinder](https://intelfinder.com)
- [Zapier Integration](https://zapier.com/apps/intelfinder/integrations)
