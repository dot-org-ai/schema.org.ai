...
await $.Technology.create(getmax)
```

## Resources

- [Getmax](https://getmax.com)
- [Zapier Integration](https://zapier.com/apps/getmax/integrations)
