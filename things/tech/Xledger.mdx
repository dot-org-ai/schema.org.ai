...
- NewlyModified.created
- NewlyReconciled.created
...
await $.Technology.create(xledger)
```

## Resources

- [Xledger](https://xledger.com)
- [Zapier Integration](https://zapier.com/apps/xledger/integrations)
