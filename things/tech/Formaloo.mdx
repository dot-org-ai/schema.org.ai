...
await $.Technology.create(formaloo)
```

## Resources

- [Formaloo](https://formaloo.com)
- [Zapier Integration](https://zapier.com/apps/formaloo/integrations)
