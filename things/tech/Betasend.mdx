...
await $.Technology.create(betasend)
```

## Resources

- [Betasend](https://betasend.com)
- [Zapier Integration](https://zapier.com/apps/betasend/integrations)
