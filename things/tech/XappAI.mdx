...
await $.Technology.create(xappai)
```

## Resources

- [Xapp AI](https://xappai.com)
- [Zapier Integration](https://zapier.com/apps/xapp-ai/integrations)
