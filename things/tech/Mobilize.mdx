...
await $.Technology.create(mobilize)
```

## Resources

- [Mobilize](https://mobilize.com)
- [Zapier Integration](https://zapier.com/apps/mobilize/integrations)
