...
await $.Technology.create(formdesk)
```

## Resources

- [Formdesk](https://formdesk.com)
- [Zapier Integration](https://zapier.com/apps/formdesk/integrations)
