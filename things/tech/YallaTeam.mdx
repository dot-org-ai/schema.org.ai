...
await $.Technology.create(yallateam)
```

## Resources

- [Yalla Team](https://yallateam.com)
- [Zapier Integration](https://zapier.com/apps/yalla-team/integrations)
