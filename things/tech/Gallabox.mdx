...
await $.Technology.create(gallabox)
```

## Resources

- [Gallabox](https://gallabox.com)
- [Zapier Integration](https://zapier.com/apps/gallabox/integrations)
