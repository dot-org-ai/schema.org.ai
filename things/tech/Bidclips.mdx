...
await $.Technology.create(bidclips)
```

## Resources

- [Bidclips](https://bidclips.com)
- [Zapier Integration](https://zapier.com/apps/bidclips/integrations)
