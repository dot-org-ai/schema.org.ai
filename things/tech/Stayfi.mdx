...
await $.Technology.create(stayfi)
```

## Resources

- [Stayfi](https://stayfi.com)
- [Zapier Integration](https://zapier.com/apps/stayfi/integrations)
