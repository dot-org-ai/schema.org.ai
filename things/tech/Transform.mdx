---
$id: https://tech.org.ai/Transform
...
await $.Technology.create(transform)
```

## Resources

- [Transform](https://transform.com)
- [Zapier Integration](https://zapier.com/apps/transform/integrations)
