---
$id: https://tech.org.ai/Handshake
...
await $.Technology.create(handshake)
```

## Resources

- [Handshake](https://handshake.com)
- [Zapier Integration](https://zapier.com/apps/handshake/integrations)
