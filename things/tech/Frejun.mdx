...
- TranscriptComplete.upload
- CalendarTranscript.unknown
...
await $.Technology.create(frejun)
```

## Resources

- [Frejun](https://frejun.com)
- [Zapier Integration](https://zapier.com/apps/frejun/integrations)
