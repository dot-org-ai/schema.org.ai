---
$id: https://tech.org.ai/Pureleads
$context: https://schema.org.ai
$type: Technology
name: Pureleads
description: Business platform for business automation
url: https://pureleads.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Pureleads
  url: https://pureleads.com
zapierSlug: pureleads
digital: 1.0
---
...
await $.Technology.create(pureleads)
```

## Resources

- [Pureleads](https://pureleads.com)
- [Zapier Integration](https://zapier.com/apps/pureleads/integrations)
