...
await $.Technology.create(intulse)
```

## Resources

- [Intulse](https://intulse.com)
- [Zapier Integration](https://zapier.com/apps/intulse/integrations)
