---
$id: https://tech.org.ai/TextRequest
$context: https://schema.org.ai
$type: Technology
name: Text Request
description: Business platform for business automation
url: https://textrequest.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Text Request
  url: https://textrequest.com
zapierSlug: text-request
digital: 1.0
---
...
await $.Technology.create(textrequest)
```

## Resources

- [Text Request](https://textrequest.com)
- [Zapier Integration](https://zapier.com/apps/text-request/integrations)
