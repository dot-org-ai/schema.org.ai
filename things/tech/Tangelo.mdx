...
await $.Technology.create(tangelo)
```

## Resources

- [Tangelo](https://tangelo.com)
- [Zapier Integration](https://zapier.com/apps/tangelo/integrations)
