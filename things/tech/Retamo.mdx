...
await $.Technology.create(retamo)
```

## Resources

- [Retamo](https://retamo.com)
- [Zapier Integration](https://zapier.com/apps/retamo/integrations)
