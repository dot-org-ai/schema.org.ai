...
await $.Technology.create(stiply)
```

## Resources

- [Stiply](https://stiply.com)
- [Zapier Integration](https://zapier.com/apps/stiply/integrations)
