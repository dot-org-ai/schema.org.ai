...
await $.Technology.create(rvmpro)
```

## Resources

- [Rvm Pro](https://rvmpro.com)
- [Zapier Integration](https://zapier.com/apps/rvm-pro/integrations)
