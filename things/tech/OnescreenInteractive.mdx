---
$id: https://tech.org.ai/OnescreenInteractive
$context: https://schema.org.ai
$type: Technology
name: Onescreen Interactive
description: Business platform for business automation
url: https://onescreeninteractive.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Onescreen Interactive
  url: https://onescreeninteractive.com
zapierSlug: onescreen-interactive
digital: 1.0
---
...
const onescreeninteractive = {
  $type: 'Technology',
  name: 'Onescreen Interactive',
  url: 'https://onescreeninteractive.com'
}

await $.Technology.create(onescreeninteractive)
```

## Resources

- [Onescreen Interactive](https://onescreeninteractive.com)
- [Zapier Integration](https://zapier.com/apps/onescreen-interactive/integrations)
