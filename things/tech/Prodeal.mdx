...
await $.Technology.create(prodeal)
```

## Resources

- [Prodeal](https://prodeal.com)
- [Zapier Integration](https://zapier.com/apps/prodeal/integrations)
