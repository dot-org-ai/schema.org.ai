...
await $.Technology.create(imeetify)
```

## Resources

- [Imeetify](https://imeetify.com)
- [Zapier Integration](https://zapier.com/apps/imeetify/integrations)
