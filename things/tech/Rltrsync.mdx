...
await $.Technology.create(rltrsync)
```

## Resources

- [Rltrsync](https://rltrsync.com)
- [Zapier Integration](https://zapier.com/apps/rltrsync/integrations)
