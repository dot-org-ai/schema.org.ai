...
await $.Technology.create(vocalip)
```

## Resources

- [Vocalip](https://vocalip.com)
- [Zapier Integration](https://zapier.com/apps/vocalip/integrations)
