---
$id: https://tech.org.ai/Kloudlearn
$context: https://schema.org.ai
$type: Technology
name: Kloudlearn
description: Business platform for business automation
url: https://kloudlearn.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Kloudlearn
  url: https://kloudlearn.com
zapierSlug: kloudlearn
digital: 1.0
---
...
await $.Technology.create(kloudlearn)
```

## Resources

- [Kloudlearn](https://kloudlearn.com)
- [Zapier Integration](https://zapier.com/apps/kloudlearn/integrations)
