---
$id: https://tech.org.ai/Craftdraft
$context: https://schema.org.ai
$type: Technology
name: Craftdraft
description: Business platform for business automation
url: https://craftdraft.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Craftdraft
  url: https://craftdraft.com
zapierSlug: craftdraft
digital: 1.0
---
...
await $.Technology.create(craftdraft)
```

## Resources

- [Craftdraft](https://craftdraft.com)
- [Zapier Integration](https://zapier.com/apps/craftdraft/integrations)
