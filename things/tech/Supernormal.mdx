---
$id: https://tech.org.ai/Supernormal
...
await $.Technology.create(supernormal)
```

## Resources

- [Supernormal](https://supernormal.com)
- [Zapier Integration](https://zapier.com/apps/supernormal/integrations)
