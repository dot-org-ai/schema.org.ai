...
await $.Technology.create(cronly)
```

## Resources

- [Cronly](https://cronly.com)
- [Zapier Integration](https://zapier.com/apps/cronly/integrations)
