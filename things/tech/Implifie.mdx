...
await $.Technology.create(implifie)
```

## Resources

- [Implifie](https://implifie.com)
- [Zapier Integration](https://zapier.com/apps/implifie/integrations)
