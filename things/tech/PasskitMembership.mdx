---
$id: https://tech.org.ai/PasskitMembership
$context: https://schema.org.ai
$type: Technology
name: Passkit Membership
description: Business platform for business automation
url: https://passkitmembership.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Passkit Membership
  url: https://passkitmembership.com
zapierSlug: passkit-membership
digital: 1.0
---
...
- Enrollment.created
- PassInstalled.unknown
- PassUninstalled.unknown
...
const passkitmembership = {
  $type: 'Technology',
  name: 'Passkit Membership',
  url: 'https://passkitmembership.com'
}

await $.Technology.create(passkitmembership)
```

## Resources

- [Passkit Membership](https://passkitmembership.com)
- [Zapier Integration](https://zapier.com/apps/passkit-membership/integrations)
