---
$id: https://tech.org.ai/Campaignware
$context: https://schema.org.ai
$type: Technology
name: Campaignware
description: Business platform for business automation
url: https://campaignware.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Campaignware
  url: https://campaignware.com
zapierSlug: campaignware
digital: 1.0
---
...
await $.Technology.create(campaignware)
```

## Resources

- [Campaignware](https://campaignware.com)
- [Zapier Integration](https://zapier.com/apps/campaignware/integrations)
