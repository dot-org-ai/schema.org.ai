...
await $.Technology.create(momindum)
```

## Resources

- [Momindum](https://momindum.com)
- [Zapier Integration](https://zapier.com/apps/momindum/integrations)
