...
await $.Technology.create(peeplo)
```

## Resources

- [Peeplo](https://peeplo.com)
- [Zapier Integration](https://zapier.com/apps/peeplo/integrations)
