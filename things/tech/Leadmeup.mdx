...
await $.Technology.create(leadmeup)
```

## Resources

- [Leadmeup](https://leadmeup.com)
- [Zapier Integration](https://zapier.com/apps/leadmeup/integrations)
