...
await $.Technology.create(loystar)
```

## Resources

- [Loystar](https://loystar.com)
- [Zapier Integration](https://zapier.com/apps/loystar/integrations)
