...
await $.Technology.create(workstack)
```

## Resources

- [Workstack](https://workstack.com)
- [Zapier Integration](https://zapier.com/apps/workstack/integrations)
