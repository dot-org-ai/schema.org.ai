...
await $.Technology.create(safsira)
```

## Resources

- [Safsira](https://safsira.com)
- [Zapier Integration](https://zapier.com/apps/safsira/integrations)
