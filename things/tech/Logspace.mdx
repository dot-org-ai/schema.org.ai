...
await $.Technology.create(logspace)
```

## Resources

- [Logspace](https://logspace.com)
- [Zapier Integration](https://zapier.com/apps/logspace/integrations)
