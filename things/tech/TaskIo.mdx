...
await $.Technology.create(taskio)
```

## Resources

- [Task Io](https://taskio.com)
- [Zapier Integration](https://zapier.com/apps/task-io/integrations)
