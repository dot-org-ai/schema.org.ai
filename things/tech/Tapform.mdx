...
await $.Technology.create(tapform)
```

## Resources

- [Tapform](https://tapform.com)
- [Zapier Integration](https://zapier.com/apps/tapform/integrations)
