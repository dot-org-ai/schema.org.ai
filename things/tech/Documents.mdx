...
await $.Technology.create(documents)
```

## Resources

- [Documents](https://documents.com)
- [Zapier Integration](https://zapier.com/apps/documents/integrations)
