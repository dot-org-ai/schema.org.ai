...
await $.Technology.create(pronnel)
```

## Resources

- [Pronnel](https://pronnel.com)
- [Zapier Integration](https://zapier.com/apps/pronnel/integrations)
