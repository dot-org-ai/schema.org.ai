---
$id: https://tech.org.ai/Groupified
$context: https://schema.org.ai
$type: Technology
name: Groupified
description: Business platform for business automation
url: https://groupified.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Groupified
  url: https://groupified.com
zapierSlug: groupified
digital: 1.0
---
...
await $.Technology.create(groupified)
```

## Resources

- [Groupified](https://groupified.com)
- [Zapier Integration](https://zapier.com/apps/groupified/integrations)
