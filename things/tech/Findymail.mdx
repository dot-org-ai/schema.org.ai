---
$id: https://tech.org.ai/Findymail
...
await $.Technology.create(findymail)
```

## Resources

- [Findymail](https://findymail.com)
- [Zapier Integration](https://zapier.com/apps/findymail/integrations)
