...
await $.Technology.create(coworks)
```

## Resources

- [Coworks](https://coworks.com)
- [Zapier Integration](https://zapier.com/apps/coworks/integrations)
