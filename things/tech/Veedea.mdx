...
await $.Technology.create(veedea)
```

## Resources

- [Veedea](https://veedea.com)
- [Zapier Integration](https://zapier.com/apps/veedea/integrations)
