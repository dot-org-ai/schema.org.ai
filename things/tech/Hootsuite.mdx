---
$id: https://tech.org.ai/Hootsuite
...
await $.Technology.create(hootsuite)
```

## Resources

- [Hootsuite](https://hootsuite.com)
- [Zapier Integration](https://zapier.com/apps/hootsuite/integrations)
