---
$id: https://tech.org.ai/Distribute
...
await $.Technology.create(distribute)
```

## Resources

- [Distribute](https://distribute.com)
- [Zapier Integration](https://zapier.com/apps/distribute/integrations)
