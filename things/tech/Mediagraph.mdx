---
$id: https://tech.org.ai/Mediagraph
$context: https://schema.org.ai
$type: Technology
name: Mediagraph
description: Business platform for business automation
url: https://mediagraph.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Mediagraph
  url: https://mediagraph.com
zapierSlug: mediagraph
digital: 1.0
---
...
await $.Technology.create(mediagraph)
```

## Resources

- [Mediagraph](https://mediagraph.com)
- [Zapier Integration](https://zapier.com/apps/mediagraph/integrations)
