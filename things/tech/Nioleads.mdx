...
await $.Technology.create(nioleads)
```

## Resources

- [Nioleads](https://nioleads.com)
- [Zapier Integration](https://zapier.com/apps/nioleads/integrations)
