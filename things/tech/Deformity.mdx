...
await $.Technology.create(deformity)
```

## Resources

- [Deformity](https://deformity.com)
- [Zapier Integration](https://zapier.com/apps/deformity/integrations)
