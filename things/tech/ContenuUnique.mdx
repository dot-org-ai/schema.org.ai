---
$id: https://tech.org.ai/ContenuUnique
$context: https://schema.org.ai
$type: Technology
name: Contenu Unique
description: Business platform for business automation
url: https://contenuunique.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Contenu Unique
  url: https://contenuunique.com
zapierSlug: contenu-unique
digital: 1.0
---
...
await $.Technology.create(contenuunique)
```

## Resources

- [Contenu Unique](https://contenuunique.com)
- [Zapier Integration](https://zapier.com/apps/contenu-unique/integrations)
