...
await $.Technology.create(evalumo)
```

## Resources

- [Evalumo](https://evalumo.com)
- [Zapier Integration](https://zapier.com/apps/evalumo/integrations)
