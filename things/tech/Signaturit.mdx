---
$id: https://tech.org.ai/Signaturit
$context: https://schema.org.ai
$type: Technology
name: Signaturit
description: Business platform for business automation
url: https://signaturit.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Signaturit
  url: https://signaturit.com
zapierSlug: signaturit
digital: 1.0
---
...
await $.Technology.create(signaturit)
```

## Resources

- [Signaturit](https://signaturit.com)
- [Zapier Integration](https://zapier.com/apps/signaturit/integrations)
