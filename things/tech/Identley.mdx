...
await $.Technology.create(identley)
```

## Resources

- [Identley](https://identley.com)
- [Zapier Integration](https://zapier.com/apps/identley/integrations)
