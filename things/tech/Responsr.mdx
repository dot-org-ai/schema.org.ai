...
await $.Technology.create(responsr)
```

## Resources

- [Responsr](https://responsr.com)
- [Zapier Integration](https://zapier.com/apps/responsr/integrations)
