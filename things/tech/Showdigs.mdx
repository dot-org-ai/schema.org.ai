...
await $.Technology.create(showdigs)
```

## Resources

- [Showdigs](https://showdigs.com)
- [Zapier Integration](https://zapier.com/apps/showdigs/integrations)
