...
await $.Technology.create(tabidoo)
```

## Resources

- [Tabidoo](https://tabidoo.com)
- [Zapier Integration](https://zapier.com/apps/tabidoo/integrations)
