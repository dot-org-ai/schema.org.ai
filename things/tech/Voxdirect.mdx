---
$id: https://tech.org.ai/Voxdirect
$context: https://schema.org.ai
$type: Technology
name: Voxdirect
description: Business platform for business automation
url: https://voxdirect.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Voxdirect
  url: https://voxdirect.com
zapierSlug: voxdirect
digital: 1.0
---
...
await $.Technology.create(voxdirect)
```

## Resources

- [Voxdirect](https://voxdirect.com)
- [Zapier Integration](https://zapier.com/apps/voxdirect/integrations)
