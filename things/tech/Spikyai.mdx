...
await $.Technology.create(spikyai)
```

## Resources

- [Spikyai](https://spikyai.com)
- [Zapier Integration](https://zapier.com/apps/spikyai/integrations)
