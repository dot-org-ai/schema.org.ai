---
$id: https://tech.org.ai/Frontlead
$context: https://schema.org.ai
$type: Technology
name: Frontlead
description: Business platform for business automation
url: https://frontlead.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Frontlead
  url: https://frontlead.com
zapierSlug: frontlead
digital: 1.0
---
...
await $.Technology.create(frontlead)
```

## Resources

- [Frontlead](https://frontlead.com)
- [Zapier Integration](https://zapier.com/apps/frontlead/integrations)
