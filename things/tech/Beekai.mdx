...
await $.Technology.create(beekai)
```

## Resources

- [Beekai](https://beekai.com)
- [Zapier Integration](https://zapier.com/apps/beekai/integrations)
