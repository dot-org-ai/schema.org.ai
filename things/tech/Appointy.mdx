...
await $.Technology.create(appointy)
```

## Resources

- [Appointy](https://appointy.com)
- [Zapier Integration](https://zapier.com/apps/appointy/integrations)
