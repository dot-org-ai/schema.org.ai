...
await $.Technology.create(pushtech)
```

## Resources

- [Pushtech](https://pushtech.com)
- [Zapier Integration](https://zapier.com/apps/pushtech/integrations)
