...
await $.Technology.create(closum)
```

## Resources

- [Closum](https://closum.com)
- [Zapier Integration](https://zapier.com/apps/closum/integrations)
