...
await $.Technology.create(touchsms)
```

## Resources

- [Touchsms](https://touchsms.com)
- [Zapier Integration](https://zapier.com/apps/touchsms/integrations)
