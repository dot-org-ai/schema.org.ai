...
await $.Technology.create(calibre)
```

## Resources

- [Calibre](https://calibre.com)
- [Zapier Integration](https://zapier.com/apps/calibre/integrations)
