...
await $.Technology.create(clevero)
```

## Resources

- [Clevero](https://clevero.com)
- [Zapier Integration](https://zapier.com/apps/clevero/integrations)
