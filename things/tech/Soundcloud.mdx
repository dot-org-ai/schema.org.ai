---
$id: https://tech.org.ai/Soundcloud
...
await $.Technology.create(soundcloud)
```

## Resources

- [Soundcloud](https://soundcloud.com)
- [Zapier Integration](https://zapier.com/apps/soundcloud/integrations)
