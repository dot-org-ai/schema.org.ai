...
await $.Technology.create(salesboard)
```

## Resources

- [Salesboard](https://salesboard.com)
- [Zapier Integration](https://zapier.com/apps/salesboard/integrations)
