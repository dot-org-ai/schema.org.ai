---
$id: https://tech.org.ai/Safetyculture
...
await $.Technology.create(safetyculture)
```

## Resources

- [Safetyculture](https://safetyculture.com)
- [Zapier Integration](https://zapier.com/apps/safetyculture/integrations)
