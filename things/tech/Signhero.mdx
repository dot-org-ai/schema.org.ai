...
await $.Technology.create(signhero)
```

## Resources

- [Signhero](https://signhero.com)
- [Zapier Integration](https://zapier.com/apps/signhero/integrations)
