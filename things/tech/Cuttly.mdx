...
await $.Technology.create(cuttly)
```

## Resources

- [Cuttly](https://cuttly.com)
- [Zapier Integration](https://zapier.com/apps/cuttly/integrations)
