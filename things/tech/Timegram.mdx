...
await $.Technology.create(timegram)
```

## Resources

- [Timegram](https://timegram.com)
- [Zapier Integration](https://zapier.com/apps/timegram/integrations)
