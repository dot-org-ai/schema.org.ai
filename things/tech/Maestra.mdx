...
await $.Technology.create(maestra)
```

## Resources

- [Maestra](https://maestra.com)
- [Zapier Integration](https://zapier.com/apps/maestra/integrations)
