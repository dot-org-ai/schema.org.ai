...
await $.Technology.create(clarizengo)
```

## Resources

- [Clarizen Go](https://clarizengo.com)
- [Zapier Integration](https://zapier.com/apps/clarizen-go/integrations)
