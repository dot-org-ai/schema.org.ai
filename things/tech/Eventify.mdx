...
await $.Technology.create(eventify)
```

## Resources

- [Eventify](https://eventify.com)
- [Zapier Integration](https://zapier.com/apps/eventify/integrations)
