...
await $.Technology.create(userhelp)
```

## Resources

- [Userhelp](https://userhelp.com)
- [Zapier Integration](https://zapier.com/apps/userhelp/integrations)
