---
$id: https://tech.org.ai/Audiogram
$context: https://schema.org.ai
$type: Technology
name: Audiogram
description: Business platform for business automation
url: https://audiogram.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Audiogram
  url: https://audiogram.com
zapierSlug: audiogram
digital: 1.0
---
...
await $.Technology.create(audiogram)
```

## Resources

- [Audiogram](https://audiogram.com)
- [Zapier Integration](https://zapier.com/apps/audiogram/integrations)
