---
$id: https://tech.org.ai/Getprospect
...
await $.Technology.create(getprospect)
```

## Resources

- [Getprospect](https://getprospect.com)
- [Zapier Integration](https://zapier.com/apps/getprospect/integrations)
