...
await $.Technology.create(truffle)
```

## Resources

- [Truffle](https://truffle.com)
- [Zapier Integration](https://zapier.com/apps/truffle/integrations)
