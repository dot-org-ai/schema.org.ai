...
await $.Technology.create(eposnow)
```

## Resources

- [Epos Now](https://eposnow.com)
- [Zapier Integration](https://zapier.com/apps/epos-now/integrations)
