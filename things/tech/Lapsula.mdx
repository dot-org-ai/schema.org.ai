...
- PortalBooking.created
- AdminBooking.created
...
await $.Technology.create(lapsula)
```

## Resources

- [Lapsula](https://lapsula.com)
- [Zapier Integration](https://zapier.com/apps/lapsula/integrations)
