...
await $.Technology.create(docnify)
```

## Resources

- [Docnify](https://docnify.com)
- [Zapier Integration](https://zapier.com/apps/docnify/integrations)
