...
await $.Technology.create(invivox)
```

## Resources

- [Invivox](https://invivox.com)
- [Zapier Integration](https://zapier.com/apps/invivox/integrations)
