...
- OutboundLead.created
- OutboundPing.created
- PongResult.created
...
await $.Technology.create(xzazu)
```

## Resources

- [Xzazu](https://xzazu.com)
- [Zapier Integration](https://zapier.com/apps/xzazu/integrations)
