---
$id: https://tech.org.ai/Highattendance
$context: https://schema.org.ai
$type: Technology
name: Highattendance
description: Business platform for business automation
url: https://highattendance.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Highattendance
  url: https://highattendance.com
zapierSlug: highattendance
digital: 1.0
---
...
await $.Technology.create(highattendance)
```

## Resources

- [Highattendance](https://highattendance.com)
- [Zapier Integration](https://zapier.com/apps/highattendance/integrations)
