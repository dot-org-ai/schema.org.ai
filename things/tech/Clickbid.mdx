...
await $.Technology.create(clickbid)
```

## Resources

- [Clickbid](https://clickbid.com)
- [Zapier Integration](https://zapier.com/apps/clickbid/integrations)
