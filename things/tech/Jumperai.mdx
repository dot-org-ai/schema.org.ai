...
await $.Technology.create(jumperai)
```

## Resources

- [Jumperai](https://jumperai.com)
- [Zapier Integration](https://zapier.com/apps/jumperai/integrations)
