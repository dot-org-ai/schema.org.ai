...
await $.Technology.create(picatic)
```

## Resources

- [Picatic](https://picatic.com)
- [Zapier Integration](https://zapier.com/apps/picatic/integrations)
