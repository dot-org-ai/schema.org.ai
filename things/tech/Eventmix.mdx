...
await $.Technology.create(eventmix)
```

## Resources

- [Eventmix](https://eventmix.com)
- [Zapier Integration](https://zapier.com/apps/eventmix/integrations)
