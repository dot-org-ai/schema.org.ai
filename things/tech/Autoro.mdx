...
await $.Technology.create(autoro)
```

## Resources

- [Autoro](https://autoro.com)
- [Zapier Integration](https://zapier.com/apps/autoro/integrations)
