...
await $.Technology.create(brittco)
```

## Resources

- [Brittco](https://brittco.com)
- [Zapier Integration](https://zapier.com/apps/brittco/integrations)
