...
await $.Technology.create(privio)
```

## Resources

- [Privio](https://privio.com)
- [Zapier Integration](https://zapier.com/apps/privio/integrations)
