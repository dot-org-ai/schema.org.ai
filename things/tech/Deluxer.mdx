...
await $.Technology.create(deluxer)
```

## Resources

- [Deluxer](https://deluxer.com)
- [Zapier Integration](https://zapier.com/apps/deluxer/integrations)
