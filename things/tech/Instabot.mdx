...
await $.Technology.create(instabot)
```

## Resources

- [Instabot](https://instabot.com)
- [Zapier Integration](https://zapier.com/apps/instabot/integrations)
