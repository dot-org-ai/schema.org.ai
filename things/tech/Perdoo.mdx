...
await $.Technology.create(perdoo)
```

## Resources

- [Perdoo](https://perdoo.com)
- [Zapier Integration](https://zapier.com/apps/perdoo/integrations)
