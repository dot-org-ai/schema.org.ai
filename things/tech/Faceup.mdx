...
await $.Technology.create(faceup)
```

## Resources

- [Faceup](https://faceup.com)
- [Zapier Integration](https://zapier.com/apps/faceup/integrations)
