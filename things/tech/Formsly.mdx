...
await $.Technology.create(formsly)
```

## Resources

- [Formsly](https://formsly.com)
- [Zapier Integration](https://zapier.com/apps/formsly/integrations)
