...
await $.Technology.create(charidy)
```

## Resources

- [Charidy](https://charidy.com)
- [Zapier Integration](https://zapier.com/apps/charidy/integrations)
