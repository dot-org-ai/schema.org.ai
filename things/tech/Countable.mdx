---
$id: https://tech.org.ai/Countable
$context: https://schema.org.ai
$type: Technology
name: Countable
description: Business platform for business automation
url: https://countable.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Countable
  url: https://countable.com
zapierSlug: countable
digital: 1.0
---
...
await $.Technology.create(countable)
```

## Resources

- [Countable](https://countable.com)
- [Zapier Integration](https://zapier.com/apps/countable/integrations)
