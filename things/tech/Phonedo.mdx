...
await $.Technology.create(phonedo)
```

## Resources

- [Phonedo](https://phonedo.com)
- [Zapier Integration](https://zapier.com/apps/phonedo/integrations)
