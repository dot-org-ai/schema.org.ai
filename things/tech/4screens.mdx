...
await $.Technology.create(4screens)
```

## Resources

- [4screens](https://4screens.com)
- [Zapier Integration](https://zapier.com/apps/4screens/integrations)
