...
await $.Technology.create(uccello)
```

## Resources

- [Uccello](https://uccello.com)
- [Zapier Integration](https://zapier.com/apps/uccello/integrations)
