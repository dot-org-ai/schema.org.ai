---
$id: https://tech.org.ai/Sidedrawer
$context: https://schema.org.ai
$type: Technology
name: Sidedrawer
description: Business platform for business automation
url: https://sidedrawer.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Sidedrawer
  url: https://sidedrawer.com
zapierSlug: sidedrawer
digital: 1.0
---
...
await $.Technology.create(sidedrawer)
```

## Resources

- [Sidedrawer](https://sidedrawer.com)
- [Zapier Integration](https://zapier.com/apps/sidedrawer/integrations)
