...
await $.Technology.create(pupsai)
```

## Resources

- [Pupsai](https://pupsai.com)
- [Zapier Integration](https://zapier.com/apps/pupsai/integrations)
