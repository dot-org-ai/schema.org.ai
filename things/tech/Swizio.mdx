...
await $.Technology.create(swizio)
```

## Resources

- [Swizio](https://swizio.com)
- [Zapier Integration](https://zapier.com/apps/swizio/integrations)
