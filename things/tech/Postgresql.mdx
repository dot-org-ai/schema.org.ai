---
$id: https://tech.org.ai/Postgresql
...
await $.Technology.create(postgresql)
```

## Resources

- [Postgresql](https://postgresql.com)
- [Zapier Integration](https://zapier.com/apps/postgresql/integrations)
