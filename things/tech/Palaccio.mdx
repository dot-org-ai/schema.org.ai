...
await $.Technology.create(palaccio)
```

## Resources

- [Palaccio](https://palaccio.com)
- [Zapier Integration](https://zapier.com/apps/palaccio/integrations)
