...
await $.Technology.create(innform)
```

## Resources

- [Innform](https://innform.com)
- [Zapier Integration](https://zapier.com/apps/innform/integrations)
