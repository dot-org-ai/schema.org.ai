...
await $.Technology.create(fractel)
```

## Resources

- [Fractel](https://fractel.com)
- [Zapier Integration](https://zapier.com/apps/fractel/integrations)
