...
await $.Technology.create(gimmefy)
```

## Resources

- [Gimmefy](https://gimmefy.com)
- [Zapier Integration](https://zapier.com/apps/gimmefy/integrations)
