...
await $.Technology.create(wordapp)
```

## Resources

- [Wordapp](https://wordapp.com)
- [Zapier Integration](https://zapier.com/apps/wordapp/integrations)
