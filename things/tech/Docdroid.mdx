...
await $.Technology.create(docdroid)
```

## Resources

- [Docdroid](https://docdroid.com)
- [Zapier Integration](https://zapier.com/apps/docdroid/integrations)
