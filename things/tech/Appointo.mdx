...
await $.Technology.create(appointo)
```

## Resources

- [Appointo](https://appointo.com)
- [Zapier Integration](https://zapier.com/apps/appointo/integrations)
