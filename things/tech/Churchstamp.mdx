---
$id: https://tech.org.ai/Churchstamp
$context: https://schema.org.ai
$type: Technology
name: Churchstamp
description: Business platform for business automation
url: https://churchstamp.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Churchstamp
  url: https://churchstamp.com
zapierSlug: churchstamp
digital: 1.0
---
...
await $.Technology.create(churchstamp)
```

## Resources

- [Churchstamp](https://churchstamp.com)
- [Zapier Integration](https://zapier.com/apps/churchstamp/integrations)
