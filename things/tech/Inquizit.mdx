...
await $.Technology.create(inquizit)
```

## Resources

- [Inquizit](https://inquizit.com)
- [Zapier Integration](https://zapier.com/apps/inquizit/integrations)
