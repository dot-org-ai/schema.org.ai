...
await $.Technology.create(orioly)
```

## Resources

- [Orioly](https://orioly.com)
- [Zapier Integration](https://zapier.com/apps/orioly/integrations)
