...
await $.Technology.create(payday)
```

## Resources

- [Payday](https://payday.com)
- [Zapier Integration](https://zapier.com/apps/payday/integrations)
