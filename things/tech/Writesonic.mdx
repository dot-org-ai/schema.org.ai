---
$id: https://tech.org.ai/Writesonic
...
await $.Technology.create(writesonic)
```

## Resources

- [Writesonic](https://writesonic.com)
- [Zapier Integration](https://zapier.com/apps/writesonic/integrations)
