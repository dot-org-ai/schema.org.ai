...
await $.Technology.create(minform)
```

## Resources

- [Minform](https://minform.com)
- [Zapier Integration](https://zapier.com/apps/minform/integrations)
