...
await $.Technology.create(binderp)
```

## Resources

- [Bind ERP](https://binderp.com)
- [Zapier Integration](https://zapier.com/apps/bind-erp/integrations)
