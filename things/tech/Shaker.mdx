...
await $.Technology.create(shaker)
```

## Resources

- [Shaker](https://shaker.com)
- [Zapier Integration](https://zapier.com/apps/shaker/integrations)
