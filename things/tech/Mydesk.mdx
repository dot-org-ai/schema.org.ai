...
await $.Technology.create(mydesk)
```

## Resources

- [Mydesk](https://mydesk.com)
- [Zapier Integration](https://zapier.com/apps/mydesk/integrations)
