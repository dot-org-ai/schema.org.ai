---
$id: https://tech.org.ai/Mailshunt
...
await $.Technology.create(mailshunt)
```

## Resources

- [Mailshunt](https://mailshunt.com)
- [Zapier Integration](https://zapier.com/apps/mailshunt/integrations)
