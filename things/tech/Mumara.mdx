...
await $.Technology.create(mumara)
```

## Resources

- [Mumara](https://mumara.com)
- [Zapier Integration](https://zapier.com/apps/mumara/integrations)
