...
await $.Technology.create(sotellus)
```

## Resources

- [Sotellus](https://sotellus.com)
- [Zapier Integration](https://zapier.com/apps/sotellus/integrations)
