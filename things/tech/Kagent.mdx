...
await $.Technology.create(kagent)
```

## Resources

- [Kagent](https://kagent.com)
- [Zapier Integration](https://zapier.com/apps/kagent/integrations)
