...
await $.Technology.create(emojot)
```

## Resources

- [Emojot](https://emojot.com)
- [Zapier Integration](https://zapier.com/apps/emojot/integrations)
