...
await $.Technology.create(divvyhq)
```

## Resources

- [Divvyhq](https://divvyhq.com)
- [Zapier Integration](https://zapier.com/apps/divvyhq/integrations)
