---
$id: https://tech.org.ai/Viralsweep
...
await $.Technology.create(viralsweep)
```

## Resources

- [Viralsweep](https://viralsweep.com)
- [Zapier Integration](https://zapier.com/apps/viralsweep/integrations)
