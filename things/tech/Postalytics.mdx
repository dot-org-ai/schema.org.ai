---
$id: https://tech.org.ai/Postalytics
$context: https://schema.org.ai
$type: Technology
name: Postalytics
description: Business platform for business automation
url: https://postalytics.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Postalytics
  url: https://postalytics.com
zapierSlug: postalytics
digital: 1.0
---
...
await $.Technology.create(postalytics)
```

## Resources

- [Postalytics](https://postalytics.com)
- [Zapier Integration](https://zapier.com/apps/postalytics/integrations)
