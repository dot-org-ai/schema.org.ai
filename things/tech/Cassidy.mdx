...
await $.Technology.create(cassidy)
```

## Resources

- [Cassidy](https://cassidy.com)
- [Zapier Integration](https://zapier.com/apps/cassidy/integrations)
