...
await $.Technology.create(rentman)
```

## Resources

- [Rentman](https://rentman.com)
- [Zapier Integration](https://zapier.com/apps/rentman/integrations)
