...
await $.Technology.create(neaktor)
```

## Resources

- [Neaktor](https://neaktor.com)
- [Zapier Integration](https://zapier.com/apps/neaktor/integrations)
