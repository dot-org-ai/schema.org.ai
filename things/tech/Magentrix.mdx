...
await $.Technology.create(magentrix)
```

## Resources

- [Magentrix](https://magentrix.com)
- [Zapier Integration](https://zapier.com/apps/magentrix/integrations)
