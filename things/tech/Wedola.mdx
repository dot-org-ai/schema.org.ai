...
await $.Technology.create(wedola)
```

## Resources

- [Wedola](https://wedola.com)
- [Zapier Integration](https://zapier.com/apps/wedola/integrations)
