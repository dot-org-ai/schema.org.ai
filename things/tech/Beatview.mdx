...
await $.Technology.create(beatview)
```

## Resources

- [Beatview](https://beatview.com)
- [Zapier Integration](https://zapier.com/apps/beatview/integrations)
