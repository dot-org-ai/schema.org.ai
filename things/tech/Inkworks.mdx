...
await $.Technology.create(inkworks)
```

## Resources

- [Inkworks](https://inkworks.com)
- [Zapier Integration](https://zapier.com/apps/inkworks/integrations)
