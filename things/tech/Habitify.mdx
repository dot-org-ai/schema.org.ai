...
await $.Technology.create(habitify)
```

## Resources

- [Habitify](https://habitify.com)
- [Zapier Integration](https://zapier.com/apps/habitify/integrations)
