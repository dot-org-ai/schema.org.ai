...
await $.Technology.create(workee)
```

## Resources

- [Workee](https://workee.com)
- [Zapier Integration](https://zapier.com/apps/workee/integrations)
