...
await $.Technology.create(chatex)
```

## Resources

- [Chatex](https://chatex.com)
- [Zapier Integration](https://zapier.com/apps/chatex/integrations)
