...
await $.Technology.create(casepeer)
```

## Resources

- [Casepeer](https://casepeer.com)
- [Zapier Integration](https://zapier.com/apps/casepeer/integrations)
