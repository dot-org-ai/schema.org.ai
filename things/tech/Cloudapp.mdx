...
await $.Technology.create(cloudapp)
```

## Resources

- [Cloudapp](https://cloudapp.com)
- [Zapier Integration](https://zapier.com/apps/cloudapp/integrations)
