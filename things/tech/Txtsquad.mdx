...
await $.Technology.create(txtsquad)
```

## Resources

- [Txtsquad](https://txtsquad.com)
- [Zapier Integration](https://zapier.com/apps/txtsquad/integrations)
