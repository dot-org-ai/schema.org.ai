---
$id: https://tech.org.ai/Cloudmattr
$context: https://schema.org.ai
$type: Technology
name: Cloudmattr
description: Business platform for business automation
url: https://cloudmattr.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Cloudmattr
  url: https://cloudmattr.com
zapierSlug: cloudmattr
digital: 1.0
---
...
await $.Technology.create(cloudmattr)
```

## Resources

- [Cloudmattr](https://cloudmattr.com)
- [Zapier Integration](https://zapier.com/apps/cloudmattr/integrations)
