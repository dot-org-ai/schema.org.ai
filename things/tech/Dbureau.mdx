...
await $.Technology.create(dbureau)
```

## Resources

- [Dbureau](https://dbureau.com)
- [Zapier Integration](https://zapier.com/apps/dbureau/integrations)
