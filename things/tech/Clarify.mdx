...
await $.Technology.create(clarify)
```

## Resources

- [Clarify](https://clarify.com)
- [Zapier Integration](https://zapier.com/apps/clarify/integrations)
