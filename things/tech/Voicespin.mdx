---
$id: https://tech.org.ai/Voicespin
$context: https://schema.org.ai
$type: Technology
name: Voicespin
description: Business platform for business automation
url: https://voicespin.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Voicespin
  url: https://voicespin.com
zapierSlug: voicespin
digital: 1.0
---
...
await $.Technology.create(voicespin)
```

## Resources

- [Voicespin](https://voicespin.com)
- [Zapier Integration](https://zapier.com/apps/voicespin/integrations)
