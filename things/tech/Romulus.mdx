...
await $.Technology.create(romulus)
```

## Resources

- [Romulus](https://romulus.com)
- [Zapier Integration](https://zapier.com/apps/romulus/integrations)
