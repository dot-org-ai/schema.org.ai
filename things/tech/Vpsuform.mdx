...
await $.Technology.create(vpsuform)
```

## Resources

- [Vpsuform](https://vpsuform.com)
- [Zapier Integration](https://zapier.com/apps/vpsuform/integrations)
