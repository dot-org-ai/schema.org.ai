...
await $.Technology.create(umsatzio)
```

## Resources

- [Umsatzio](https://umsatzio.com)
- [Zapier Integration](https://zapier.com/apps/umsatzio/integrations)
