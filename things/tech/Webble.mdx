...
await $.Technology.create(webble)
```

## Resources

- [Webble](https://webble.com)
- [Zapier Integration](https://zapier.com/apps/webble/integrations)
