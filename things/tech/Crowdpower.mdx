---
$id: https://tech.org.ai/Crowdpower
$context: https://schema.org.ai
$type: Technology
name: Crowdpower
description: Business platform for business automation
url: https://crowdpower.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Crowdpower
  url: https://crowdpower.com
zapierSlug: crowdpower
digital: 1.0
---
...
await $.Technology.create(crowdpower)
```

## Resources

- [Crowdpower](https://crowdpower.com)
- [Zapier Integration](https://zapier.com/apps/crowdpower/integrations)
