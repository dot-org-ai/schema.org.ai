---
$id: https://tech.org.ai/Maxcustomer
$context: https://schema.org.ai
$type: Technology
name: Maxcustomer
description: Business platform for business automation
url: https://maxcustomer.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Maxcustomer
  url: https://maxcustomer.com
zapierSlug: maxcustomer
digital: 1.0
---
...
await $.Technology.create(maxcustomer)
```

## Resources

- [Maxcustomer](https://maxcustomer.com)
- [Zapier Integration](https://zapier.com/apps/maxcustomer/integrations)
