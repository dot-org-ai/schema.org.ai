---
$id: https://tech.org.ai/WebinarnetEu
$context: https://schema.org.ai
$type: Technology
name: Webinarnet Eu
description: Business platform for business automation
url: https://webinarneteu.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Webinarnet Eu
  url: https://webinarneteu.com
zapierSlug: webinarnet-eu
digital: 1.0
---
...
await $.Technology.create(webinarneteu)
```

## Resources

- [Webinarnet Eu](https://webinarneteu.com)
- [Zapier Integration](https://zapier.com/apps/webinarnet-eu/integrations)
