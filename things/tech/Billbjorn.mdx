---
$id: https://tech.org.ai/Billbjorn
$context: https://schema.org.ai
$type: Technology
name: Billbjorn
description: Business platform for business automation
url: https://billbjorn.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Billbjorn
  url: https://billbjorn.com
zapierSlug: billbjorn
digital: 1.0
---
...
await $.Technology.create(billbjorn)
```

## Resources

- [Billbjorn](https://billbjorn.com)
- [Zapier Integration](https://zapier.com/apps/billbjorn/integrations)
