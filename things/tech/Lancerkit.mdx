---
$id: https://tech.org.ai/Lancerkit
$context: https://schema.org.ai
$type: Technology
name: Lancerkit
description: Business platform for business automation
url: https://lancerkit.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Lancerkit
  url: https://lancerkit.com
zapierSlug: lancerkit
digital: 1.0
---
...
await $.Technology.create(lancerkit)
```

## Resources

- [Lancerkit](https://lancerkit.com)
- [Zapier Integration](https://zapier.com/apps/lancerkit/integrations)
