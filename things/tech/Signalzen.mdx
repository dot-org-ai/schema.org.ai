...
await $.Technology.create(signalzen)
```

## Resources

- [Signalzen](https://signalzen.com)
- [Zapier Integration](https://zapier.com/apps/signalzen/integrations)
