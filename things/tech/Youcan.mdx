...
await $.Technology.create(youcan)
```

## Resources

- [Youcan](https://youcan.com)
- [Zapier Integration](https://zapier.com/apps/youcan/integrations)
