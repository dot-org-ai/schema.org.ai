---
$id: https://tech.org.ai/Expresspigeon
$context: https://schema.org.ai
$type: Technology
name: Expresspigeon
description: Business platform for business automation
url: https://expresspigeon.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Expresspigeon
  url: https://expresspigeon.com
zapierSlug: expresspigeon
digital: 1.0
---
...
await $.Technology.create(expresspigeon)
```

## Resources

- [Expresspigeon](https://expresspigeon.com)
- [Zapier Integration](https://zapier.com/apps/expresspigeon/integrations)
