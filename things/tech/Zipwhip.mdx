...
await $.Technology.create(zipwhip)
```

## Resources

- [Zipwhip](https://zipwhip.com)
- [Zapier Integration](https://zapier.com/apps/zipwhip/integrations)
