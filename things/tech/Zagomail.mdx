...
await $.Technology.create(zagomail)
```

## Resources

- [Zagomail](https://zagomail.com)
- [Zapier Integration](https://zapier.com/apps/zagomail/integrations)
