...
await $.Technology.create(outgrow)
```

## Resources

- [Outgrow](https://outgrow.com)
- [Zapier Integration](https://zapier.com/apps/outgrow/integrations)
