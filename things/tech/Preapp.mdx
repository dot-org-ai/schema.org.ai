...
await $.Technology.create(preapp)
```

## Resources

- [Preapp](https://preapp.com)
- [Zapier Integration](https://zapier.com/apps/preapp/integrations)
