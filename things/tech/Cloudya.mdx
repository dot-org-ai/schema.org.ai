...
await $.Technology.create(cloudya)
```

## Resources

- [Cloudya](https://cloudya.com)
- [Zapier Integration](https://zapier.com/apps/cloudya/integrations)
