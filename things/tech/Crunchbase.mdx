---
$id: https://tech.org.ai/Crunchbase
...
await $.Technology.create(crunchbase)
```

## Resources

- [Crunchbase](https://crunchbase.com)
- [Zapier Integration](https://zapier.com/apps/crunchbase/integrations)
