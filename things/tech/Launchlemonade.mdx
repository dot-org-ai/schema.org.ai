---
$id: https://tech.org.ai/Launchlemonade
$context: https://schema.org.ai
$type: Technology
name: Launchlemonade
description: Business platform for business automation
url: https://launchlemonade.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Launchlemonade
  url: https://launchlemonade.com
zapierSlug: launchlemonade
digital: 1.0
---
...
const launchlemonade = {
  $type: 'Technology',
  name: 'Launchlemonade',
  url: 'https://launchlemonade.com'
}

await $.Technology.create(launchlemonade)
```

## Resources

- [Launchlemonade](https://launchlemonade.com)
- [Zapier Integration](https://zapier.com/apps/launchlemonade/integrations)
