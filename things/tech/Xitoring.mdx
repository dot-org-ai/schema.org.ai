...
await $.Technology.create(xitoring)
```

## Resources

- [Xitoring](https://xitoring.com)
- [Zapier Integration](https://zapier.com/apps/xitoring/integrations)
