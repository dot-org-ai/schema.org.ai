---
$id: https://tech.org.ai/Leadbooker
$context: https://schema.org.ai
$type: Technology
name: Leadbooker
description: Business platform for business automation
url: https://leadbooker.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Leadbooker
  url: https://leadbooker.com
zapierSlug: leadbooker
digital: 1.0
---
...
await $.Technology.create(leadbooker)
```

## Resources

- [Leadbooker](https://leadbooker.com)
- [Zapier Integration](https://zapier.com/apps/leadbooker/integrations)
