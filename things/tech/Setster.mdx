...
await $.Technology.create(setster)
```

## Resources

- [Setster](https://setster.com)
- [Zapier Integration](https://zapier.com/apps/setster/integrations)
