---
$id: https://tech.org.ai/Typeflowai
...
await $.Technology.create(typeflowai)
```

## Resources

- [Typeflowai](https://typeflowai.com)
- [Zapier Integration](https://zapier.com/apps/typeflowai/integrations)
