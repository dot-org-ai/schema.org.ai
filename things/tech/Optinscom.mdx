---
$id: https://tech.org.ai/Optinscom
$context: https://schema.org.ai
$type: Technology
name: Optinscom
description: Business platform for business automation
url: https://optinscom.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Optinscom
  url: https://optinscom.com
zapierSlug: optinscom
digital: 1.0
---
...
await $.Technology.create(optinscom)
```

## Resources

- [Optinscom](https://optinscom.com)
- [Zapier Integration](https://zapier.com/apps/optinscom/integrations)
