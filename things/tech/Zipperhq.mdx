...
await $.Technology.create(zipperhq)
```

## Resources

- [Zipperhq](https://zipperhq.com)
- [Zapier Integration](https://zapier.com/apps/zipperhq/integrations)
