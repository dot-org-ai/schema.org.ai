...
- Lead.created
- CampaignMaps.created
- CampaignSerp.created
...
await $.Technology.create(spylead)
```

## Resources

- [Spylead](https://spylead.com)
- [Zapier Integration](https://zapier.com/apps/spylead/integrations)
