...
await $.Technology.create(playfilm)
```

## Resources

- [Playfilm](https://playfilm.com)
- [Zapier Integration](https://zapier.com/apps/playfilm/integrations)
