---
$id: https://tech.org.ai/ProductForge
$context: https://schema.org.ai
$type: Technology
name: Product Forge
description: Business platform for business automation
url: https://productforge.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Product Forge
  url: https://productforge.com
zapierSlug: product-forge
digital: 1.0
---
...
await $.Technology.create(productforge)
```

## Resources

- [Product Forge](https://productforge.com)
- [Zapier Integration](https://zapier.com/apps/product-forge/integrations)
