...
await $.Technology.create(skilljar)
```

## Resources

- [Skilljar](https://skilljar.com)
- [Zapier Integration](https://zapier.com/apps/skilljar/integrations)
