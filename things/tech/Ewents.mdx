...
await $.Technology.create(ewents)
```

## Resources

- [Ewents](https://ewents.com)
- [Zapier Integration](https://zapier.com/apps/ewents/integrations)
