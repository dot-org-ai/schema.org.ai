...
await $.Technology.create(inperson)
```

## Resources

- [Inperson](https://inperson.com)
- [Zapier Integration](https://zapier.com/apps/inperson/integrations)
