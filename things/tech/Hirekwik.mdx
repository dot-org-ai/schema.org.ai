...
await $.Technology.create(hirekwik)
```

## Resources

- [Hirekwik](https://hirekwik.com)
- [Zapier Integration](https://zapier.com/apps/hirekwik/integrations)
