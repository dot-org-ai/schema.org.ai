...
await $.Technology.create(record)
```

## Resources

- [Record](https://record.com)
- [Zapier Integration](https://zapier.com/apps/record/integrations)
