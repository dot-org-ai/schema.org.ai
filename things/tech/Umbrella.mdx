...
await $.Technology.create(umbrella)
```

## Resources

- [Umbrella](https://umbrella.com)
- [Zapier Integration](https://zapier.com/apps/umbrella/integrations)
