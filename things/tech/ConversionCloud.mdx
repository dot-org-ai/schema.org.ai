---
$id: https://tech.org.ai/ConversionCloud
$context: https://schema.org.ai
$type: Technology
name: Conversion Cloud
description: Business platform for business automation
url: https://conversioncloud.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Conversion Cloud
  url: https://conversioncloud.com
zapierSlug: conversion-cloud
digital: 1.0
---
...
const conversioncloud = {
  $type: 'Technology',
  name: 'Conversion Cloud',
  url: 'https://conversioncloud.com'
}

await $.Technology.create(conversioncloud)
```

## Resources

- [Conversion Cloud](https://conversioncloud.com)
- [Zapier Integration](https://zapier.com/apps/conversion-cloud/integrations)
