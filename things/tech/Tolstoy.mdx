...
await $.Technology.create(tolstoy)
```

## Resources

- [Tolstoy](https://tolstoy.com)
- [Zapier Integration](https://zapier.com/apps/tolstoy/integrations)
