...
await $.Technology.create(hyperise)
```

## Resources

- [Hyperise](https://hyperise.com)
- [Zapier Integration](https://zapier.com/apps/hyperise/integrations)
