...
await $.Technology.create(commonsku)
```

## Resources

- [Commonsku](https://commonsku.com)
- [Zapier Integration](https://zapier.com/apps/commonsku/integrations)
