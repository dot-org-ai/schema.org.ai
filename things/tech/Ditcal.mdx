...
await $.Technology.create(ditcal)
```

## Resources

- [Ditcal](https://ditcal.com)
- [Zapier Integration](https://zapier.com/apps/ditcal/integrations)
