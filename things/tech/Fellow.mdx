...
await $.Technology.create(fellow)
```

## Resources

- [Fellow](https://fellow.com)
- [Zapier Integration](https://zapier.com/apps/fellow/integrations)
