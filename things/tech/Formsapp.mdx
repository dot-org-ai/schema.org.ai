...
await $.Technology.create(formsapp)
```

## Resources

- [Formsapp](https://formsapp.com)
- [Zapier Integration](https://zapier.com/apps/formsapp/integrations)
