...
await $.Technology.create(mycard)
```

## Resources

- [Mycard](https://mycard.com)
- [Zapier Integration](https://zapier.com/apps/mycard/integrations)
