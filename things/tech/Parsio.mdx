...
await $.Technology.create(parsio)
```

## Resources

- [Parsio](https://parsio.com)
- [Zapier Integration](https://zapier.com/apps/parsio/integrations)
