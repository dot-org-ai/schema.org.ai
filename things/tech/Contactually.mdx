---
$id: https://tech.org.ai/Contactually
...
await $.Technology.create(contactually)
```

## Resources

- [Contactually](https://contactually.com)
- [Zapier Integration](https://zapier.com/apps/contactually/integrations)
