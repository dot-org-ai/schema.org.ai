...
await $.Technology.create(teknoir)
```

## Resources

- [Teknoir](https://teknoir.com)
- [Zapier Integration](https://zapier.com/apps/teknoir/integrations)
