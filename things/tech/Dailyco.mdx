...
await $.Technology.create(dailyco)
```

## Resources

- [Dailyco](https://dailyco.com)
- [Zapier Integration](https://zapier.com/apps/dailyco/integrations)
