...
await $.Technology.create(cliento)
```

## Resources

- [Cliento](https://cliento.com)
- [Zapier Integration](https://zapier.com/apps/cliento/integrations)
