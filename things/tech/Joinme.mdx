...
await $.Technology.create(joinme)
```

## Resources

- [Joinme](https://joinme.com)
- [Zapier Integration](https://zapier.com/apps/joinme/integrations)
