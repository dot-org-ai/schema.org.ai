---
$id: https://tech.org.ai/HelloSprout
$context: https://schema.org.ai
$type: Technology
name: Hello Sprout
description: Business platform for business automation
url: https://hellosprout.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Hello Sprout
  url: https://hellosprout.com
zapierSlug: hello-sprout
digital: 1.0
---
...
await $.Technology.create(hellosprout)
```

## Resources

- [Hello Sprout](https://hellosprout.com)
- [Zapier Integration](https://zapier.com/apps/hello-sprout/integrations)
