...
await $.Technology.create(mailtoon)
```

## Resources

- [Mailtoon](https://mailtoon.com)
- [Zapier Integration](https://zapier.com/apps/mailtoon/integrations)
