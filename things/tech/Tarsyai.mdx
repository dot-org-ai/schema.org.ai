...
await $.Technology.create(tarsyai)
```

## Resources

- [Tarsyai](https://tarsyai.com)
- [Zapier Integration](https://zapier.com/apps/tarsyai/integrations)
