...
await $.Technology.create(puntual)
```

## Resources

- [Puntual](https://puntual.com)
- [Zapier Integration](https://zapier.com/apps/puntual/integrations)
