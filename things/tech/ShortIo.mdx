...
await $.Technology.create(shortio)
```

## Resources

- [Short Io](https://shortio.com)
- [Zapier Integration](https://zapier.com/apps/short-io/integrations)
