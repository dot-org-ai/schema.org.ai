...
await $.Technology.create(fliplet)
```

## Resources

- [Fliplet](https://fliplet.com)
- [Zapier Integration](https://zapier.com/apps/fliplet/integrations)
