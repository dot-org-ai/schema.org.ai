...
await $.Technology.create(wotnot)
```

## Resources

- [Wotnot](https://wotnot.com)
- [Zapier Integration](https://zapier.com/apps/wotnot/integrations)
