...
await $.Technology.create(cikisi)
```

## Resources

- [Cikisi](https://cikisi.com)
- [Zapier Integration](https://zapier.com/apps/cikisi/integrations)
