---
$id: https://tech.org.ai/Devicemagic
...
await $.Technology.create(devicemagic)
```

## Resources

- [Devicemagic](https://devicemagic.com)
- [Zapier Integration](https://zapier.com/apps/devicemagic/integrations)
