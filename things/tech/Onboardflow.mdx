---
$id: https://tech.org.ai/Onboardflow
$context: https://schema.org.ai
$type: Technology
name: Onboardflow
description: Business platform for business automation
url: https://onboardflow.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Onboardflow
  url: https://onboardflow.com
zapierSlug: onboardflow
digital: 1.0
---
...
await $.Technology.create(onboardflow)
```

## Resources

- [Onboardflow](https://onboardflow.com)
- [Zapier Integration](https://zapier.com/apps/onboardflow/integrations)
