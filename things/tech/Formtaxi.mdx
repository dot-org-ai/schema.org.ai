...
await $.Technology.create(formtaxi)
```

## Resources

- [Formtaxi](https://formtaxi.com)
- [Zapier Integration](https://zapier.com/apps/formtaxi/integrations)
