...
await $.Technology.create(accurai)
```

## Resources

- [Accurai](https://accurai.com)
- [Zapier Integration](https://zapier.com/apps/accurai/integrations)
