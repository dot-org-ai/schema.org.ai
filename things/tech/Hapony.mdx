...
await $.Technology.create(hapony)
```

## Resources

- [Hapony](https://hapony.com)
- [Zapier Integration](https://zapier.com/apps/hapony/integrations)
