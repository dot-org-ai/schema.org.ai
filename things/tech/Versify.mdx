...
await $.Technology.create(versify)
```

## Resources

- [Versify](https://versify.com)
- [Zapier Integration](https://zapier.com/apps/versify/integrations)
