---
$id: https://tech.org.ai/Documenso
...
await $.Technology.create(documenso)
```

## Resources

- [Documenso](https://documenso.com)
- [Zapier Integration](https://zapier.com/apps/documenso/integrations)
