...
await $.Technology.create(livecall)
```

## Resources

- [Livecall](https://livecall.com)
- [Zapier Integration](https://zapier.com/apps/livecall/integrations)
