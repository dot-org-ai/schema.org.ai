---
$id: https://tech.org.ai/Wizcaller
$context: https://schema.org.ai
$type: Technology
name: Wizcaller
description: Business platform for business automation
url: https://wizcaller.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Wizcaller
  url: https://wizcaller.com
zapierSlug: wizcaller
digital: 1.0
---
...
await $.Technology.create(wizcaller)
```

## Resources

- [Wizcaller](https://wizcaller.com)
- [Zapier Integration](https://zapier.com/apps/wizcaller/integrations)
