...
await $.Technology.create(mosaic)
```

## Resources

- [Mosaic](https://mosaic.com)
- [Zapier Integration](https://zapier.com/apps/mosaic/integrations)
