...
await $.Technology.create(cloover)
```

## Resources

- [Cloover](https://cloover.com)
- [Zapier Integration](https://zapier.com/apps/cloover/integrations)
