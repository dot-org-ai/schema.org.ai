...
await $.Technology.create(hireflix)
```

## Resources

- [Hireflix](https://hireflix.com)
- [Zapier Integration](https://zapier.com/apps/hireflix/integrations)
