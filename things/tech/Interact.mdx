...
await $.Technology.create(interact)
```

## Resources

- [Interact](https://interact.com)
- [Zapier Integration](https://zapier.com/apps/interact/integrations)
