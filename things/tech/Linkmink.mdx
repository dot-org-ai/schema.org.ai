...
await $.Technology.create(linkmink)
```

## Resources

- [Linkmink](https://linkmink.com)
- [Zapier Integration](https://zapier.com/apps/linkmink/integrations)
