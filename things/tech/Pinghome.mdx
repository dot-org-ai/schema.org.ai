...
await $.Technology.create(pinghome)
```

## Resources

- [Pinghome](https://pinghome.com)
- [Zapier Integration](https://zapier.com/apps/pinghome/integrations)
