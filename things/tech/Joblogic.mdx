...
await $.Technology.create(joblogic)
```

## Resources

- [Joblogic](https://joblogic.com)
- [Zapier Integration](https://zapier.com/apps/joblogic/integrations)
