---
$id: https://tech.org.ai/Launchnotes
$context: https://schema.org.ai
$type: Technology
name: Launchnotes
description: Business platform for business automation
url: https://launchnotes.com
applicationCategory: Business Software
provider:
  $type: Organization
  name: Launchnotes
  url: https://launchnotes.com
zapierSlug: launchnotes
digital: 1.0
---
...
await $.Technology.create(launchnotes)
```

## Resources

- [Launchnotes](https://launchnotes.com)
- [Zapier Integration](https://zapier.com/apps/launchnotes/integrations)
