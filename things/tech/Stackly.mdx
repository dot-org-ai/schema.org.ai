...
await $.Technology.create(stackly)
```

## Resources

- [Stackly](https://stackly.com)
- [Zapier Integration](https://zapier.com/apps/stackly/integrations)
