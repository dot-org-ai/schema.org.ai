...
await $.Technology.create(formless)
```

## Resources

- [Formless](https://formless.com)
- [Zapier Integration](https://zapier.com/apps/formless/integrations)
