...
await $.Technology.create(andpay)
```

## Resources

- [Andpay](https://andpay.com)
- [Zapier Integration](https://zapier.com/apps/andpay/integrations)
