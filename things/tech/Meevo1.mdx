...
await $.Technology.create(meevo1)
```

## Resources

- [Meevo 1](https://meevo1.com)
- [Zapier Integration](https://zapier.com/apps/meevo-1/integrations)
