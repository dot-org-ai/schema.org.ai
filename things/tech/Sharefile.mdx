---
$id: https://tech.org.ai/Sharefile
...
await $.Technology.create(sharefile)
```

## Resources

- [Sharefile](https://sharefile.com)
- [Zapier Integration](https://zapier.com/apps/sharefile/integrations)
