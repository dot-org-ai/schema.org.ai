...
await $.Technology.create(repliq)
```

## Resources

- [Repliq](https://repliq.com)
- [Zapier Integration](https://zapier.com/apps/repliq/integrations)
