...
- PublishPinterest.unknown
- PublishInstagram.unknown
...
await $.Technology.create(publer)
```

## Resources

- [Publer](https://publer.com)
- [Zapier Integration](https://zapier.com/apps/publer/integrations)
