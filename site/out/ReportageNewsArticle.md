...
[Thing](Thing.mdx) > [CreativeWork](CreativeWork.mdx) > [Article](Article.mdx) > [NewsArticle](NewsArticle.mdx) > **ReportageNewsArticle**



## Properties

See [Schema.org ReportageNewsArticle properties](https://schema.org/ReportageNewsArticle#properties)

## Usage in Business-as-Code

```typescript
import { $ } from 'sdk.do'
import type { ReportageNewsArticle } from 'schema.org.ai'

// Create a ReportageNewsArticle
...
await $.ReportageNewsArticle.create(item)
const result = await $.ReportageNewsArticle.get('item-id')
```

## Resources

- [Schema.org ReportageNewsArticle](https://schema.org/ReportageNewsArticle)
- [ReportageNewsArticle Properties](https://schema.org/ReportageNewsArticle#properties)
