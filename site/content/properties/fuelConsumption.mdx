---
$id: https://schema.org/fuelConsumption
$context: https://schema.org
$type: Property
name: fuelConsumption
description: "The amount of fuel consumed for traveling a particular distance or temporal duration with the given vehicle (e.g. liters per 100 km). Note 1: There are unfortunately no standard unit codes for liters "
...
- [Schema.org fuelConsumption](https://schema.org/fuelConsumption)
