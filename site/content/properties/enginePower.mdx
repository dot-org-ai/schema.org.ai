...
$type: Property
name: enginePower
description: "The power of the vehicle's engine. Typical unit code(s): KWT for kilowatt, BHP for brake horsepower, N12 for metric horsepower (PS, with 1 PS = 735,49875 W) Note 1: There are many different ways of me"
title: enginePower
---
...
- [Schema.org enginePower](https://schema.org/enginePower)
