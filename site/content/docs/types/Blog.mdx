...
$type: Class
name: Blog
description: A [blog](https://en.wikipedia.org/wiki/Blog), sometimes known as a \"weblog\". Note that the individual posts (BlogPostings) in a Blog are often colloquially referred to by the same term.
subClassOf:
  - CreativeWork
title: Blog
---
